    ...
    module Configuration
      module Telephones
        class RegistrationsController < ApplicationController
          ...
          include Sign::CustomerTelephoneRegistrable
          ...
          def create
            ...
            redirect_to(
              identity.edit_sign_com_configuration_telephones_registration_path(ri: params[:ri]),
          ...
          def update
            ...
            when :locked
              ...
              redirect_to(identity.new_sign_com_configuration_telephones_registration_path(ri: params[:ri]))
            else
              render :edit, status: :unprocessable_content
            end
          end
