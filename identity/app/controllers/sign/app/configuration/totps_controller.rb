      ...
      class TotpsController < ApplicationController
        ...
        def create
          ...
          if @totp.private_key.blank?
            redirect_to(
              identity.new_sign_app_configuration_totp_path,
        ...
        def handle_success(last_otp_at)
          ...
          redirect_to(identity.sign_app_configuration_totps_path, notice: t("messages.totp_successfully_created"))
        end
        ...
        def update
          ...
          if @totp.update(update_params)
            redirect_to(
              identity.sign_app_configuration_totps_path,
