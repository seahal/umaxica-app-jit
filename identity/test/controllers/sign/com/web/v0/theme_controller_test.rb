...
class Sign::Com::Web::V0::ThemeControllerTest < ActionDispatch::IntegrationTest
  include PreferenceJwtHelper

  setup do
    _ = Preference::Base
    @host = SignHostEnv.corporate_url || "sign.com.localhost"
    host! @host
  end
  ...
  test "GET show without access jwt returns default theme sy" do
    ...
    get sign_com_web_v0_theme_path, as: :json
  ...
  test "PATCH update sets theme cookie and returns updated theme" do
    ...
    with_preference_jwt_keys(host: @host) do
      patch sign_com_web_v0_theme_path, params: { theme: "light" }, as: :json
    end
