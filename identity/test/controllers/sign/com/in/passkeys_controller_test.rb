...
class Sign::Com::In::PasskeysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "options returns challenge for known identifier" do
    ...
    Webauthn.stub(:trusted_origins, trusted_origins) do
      post identity.options_identity.sign_com_in_passkeys_path(ri: "jp"),
  ...
  test "verification logs customer in on success" do
    ...
    WebAuthn::Credential.stub(:from_get, mock_credential) do
      post identity.verification_identity.sign_com_in_passkeys_path(ri: "jp"),
           params: {
    ...
    assert_equal sign_com_configuration_path(ri: "jp"), response.parsed_body["identity.redirect_url"]
  end
end
