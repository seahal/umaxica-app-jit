...
class Sign::App::Configuration::SessionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "others revokes active sessions except current session" do
    ...
    delete identity.others_sign_app_configuration_sessions_url(ri: "jp"), headers: @headers
  ...
  test "others requires authentication" do
    delete identity.others_sign_app_configuration_sessions_url(ri: "jp"), headers: @unauthenticated_headers
  ...
  test "index shows revoke all other sessions button" do
    ...
    assert_response :success
    assert_select "form[action^='#{identity.others_sign_app_configuration_sessions_path}']"
