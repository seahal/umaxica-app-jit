...
class TestAuthenticationClientController < ApplicationController
...
module Authentication
  class ClientConcernTest < ActionDispatch::IntegrationTest
    setup do
      @controller = TestAuthenticationClientController.new
    end

    test "Authentication::Client is defined" do
      assert defined?(Authentication::Client)
    end

    test "Client concern includes Authentication::Base" do
      assert_includes TestAuthenticationClientController.ancestors, Authentication::Base
    end
