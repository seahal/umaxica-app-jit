...
class AuthorizationCodeTest < ActiveSupport::TestCase
  ...
  test "issue! creates a valid authorization code" do
    code = AuthorizationCode.issue!(
      user: @user,
      client_id: "core_app",
      redirect_uri: "http://base.app.localhost:3000/auth/callback",
  ...
  test "issue! creates a valid customer authorization code" do
    code = AuthorizationCode.issue!(
      customer: @customer,
      client_id: "core_com",
      redirect_uri: "http://base.com.localhost:3000/auth/callback",
      code_challenge: @code_challenge,
      code_challenge_method: "S256",
  ...
  test "generate_code returns unique codes" do
    codes = Array.new(10) { AuthorizationCode.generate_code }
