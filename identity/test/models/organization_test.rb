...
class OrganizationTest < ActiveSupport::TestCase
  test "does not expose departments as a workspace alias" do
    assert_nil Organization.reflect_on_association(:departments)
  end

  test "does not expose user_memberships as a workspace alias" do
    assert_nil Organization.reflect_on_association(:user_memberships)
  end
end
