...
class CustomerPreferenceLanguageTest < ActiveSupport::TestCase
  ...
  test "validates preference uniqueness and defaults option" do
    assert_preference_detail_model_behavior(
      model_class: CustomerPreferenceLanguage,
      preference: @preference,
      default_option_id: CustomerPreferenceLanguageOption::JA,
