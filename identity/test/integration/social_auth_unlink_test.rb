...
class SocialAuthUnlinkTest < ActionDispatch::IntegrationTest
  ...
  test "unlink Google requires recent reauth" do
    ...
    delete identity.sign_app_social_unlink_url(provider: "google_app", ri: "jp"),
  ...
  test "unlink Apple requires recent reauth" do
    ...
    delete identity.sign_app_social_unlink_url(provider: "apple", ri: "jp"),
           headers: as_user_headers(@user, host: @host)
  ...
  test "unlink last Google identity returns 422 LastIdentityError" do
    ...
    # Try to unlink
    delete Rails.application.routes.url_helpers.sign_identity.app_social_unlink_url(provider: "google_app", ri: "jp"),
           headers: as_user_headers(@user, host: @host)
