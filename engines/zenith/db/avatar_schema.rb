...
ActiveRecord::Schema[8.2].define(version: 20_260_410_090_004) do
  ...
  create_table "avatar_assignments", force: :cascade do |t|
    ...
    t.index(%w(avatar_id user_id role), name: "index_avatar_assignments_unique", unique: true)
  ...
  create_table "avatars", force: :cascade do |t|
    ...
    t.index(["member_id"], name: "index_avatars_on_member_id")
