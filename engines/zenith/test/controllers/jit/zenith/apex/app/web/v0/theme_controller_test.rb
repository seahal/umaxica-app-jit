...
module Jit
  module Zenith
    ...
    class Jit::Zenith::Acme::App::Web::V0::ThemeControllerTest < ActionDispatch::IntegrationTest
      ...
      test "GET show without access jwt returns default theme sy" do
        ...
        get zenith.acme_app_web_v0_theme_path, as: :json
      ...
      test "PATCH update sets theme cookie and returns updated theme" do
        ...
        with_preference_jwt_keys(host: @host) do
          patch zenith.acme_app_web_v0_theme_path, params: { theme: "dark" }, as: :json
        end
      ...
      test "PATCH update with ct param sets theme cookie" do
        ...
        with_preference_jwt_keys(host: @host) do
          patch zenith.acme_app_web_v0_theme_path, params: { ct: "li" }, as: :json
        end
