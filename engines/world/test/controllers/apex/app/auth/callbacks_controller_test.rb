...
class Apex::App::Auth::CallbacksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "oidc_callback_url omits default https port" do
    harness = build_oidc_callback_harness(host: @host, scheme: "https", port: 443, client_id: "apex_app")
  ...
  test "oidc_callback_url omits default http port" do
    harness = build_oidc_callback_harness(host: @host, scheme: "http", port: 80, client_id: "apex_app")
  ...
  test "GET show with valid state and code exchanges token and redirects to return_to" do
    ...
    freeze_time do
      ...
      expected_args = {
        ...
        client_id: "apex_app",
        client_secret: Oidc::ClientRegistry.find("apex_app")&.client_secret,
