...
class OrgDocumentBehavior < BehaviorRecord
  ...
  validates_reference_table :event_id, association: :org_document_behavior_event
  validates_reference_table :level_id, association: :org_document_behavior_level
