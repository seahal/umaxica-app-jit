...
module Jit
  module Distributor
    ...
    class Jit::Distributor::Post::Org::RootsControllerTest < ActionDispatch::IntegrationTest
      include RootThemeCookieHelper

      test "should get show" do
        get distributor.post_org_root_url

        assert_response :success
      end

      test "sets lang attribute on html element" do
        get distributor.post_org_root_url(format: :html)
