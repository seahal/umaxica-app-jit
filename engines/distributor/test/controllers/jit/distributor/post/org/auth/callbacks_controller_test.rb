...
module Jit
  module Distributor
    ...
    class Jit::Distributor::Post::Org::Auth::CallbacksControllerTest < ActionDispatch::IntegrationTest
      setup do
        @host = ENV.fetch("DISTRIBUTOR_POST_ORG_URL", "docs.org.localhost")
      end

      test "returns client_id as post_org" do
        controller = Jit::Distributor::Post::Org::Auth::CallbacksController.new
