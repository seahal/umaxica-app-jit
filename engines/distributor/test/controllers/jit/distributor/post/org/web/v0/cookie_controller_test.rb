...
module Jit
  module Distributor
    ...
    class Jit::Distributor::Post::Org::Web::V0::CookieControllerTest < ActionDispatch::IntegrationTest
      ...
      test "GET show without access jwt returns consented false" do
        ...
        get distributor.post_org_web_v0_cookie_path, as: :json
      ...
      test "PATCH update with consented true updates preference cookie and issues access token" do
        ...
        with_preference_jwt_keys(host: @host) do
          patch distributor.post_org_web_v0_cookie_path, params: { consented: true }, as: :json
        end
