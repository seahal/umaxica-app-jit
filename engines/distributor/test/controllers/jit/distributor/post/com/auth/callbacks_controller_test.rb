...
module Jit
  module Distributor
    ...
    class Jit::Distributor::Post::Com::Auth::CallbacksControllerTest < ActionDispatch::IntegrationTest
      setup do
        @host = ENV.fetch("DISTRIBUTOR_POST_COM_URL", "docs.com.localhost")
      end

      test "returns client_id as post_com" do
        controller = Jit::Distributor::Post::Com::Auth::CallbacksController.new
