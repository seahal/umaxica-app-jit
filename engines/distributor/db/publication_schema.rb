...
ActiveRecord::Schema[8.2].define(version: 20_260_408_000_000) do
  ...
  create_table "app_document_tags", force: :cascade do |t|
    ...
    t.index(
      ["app_document_tag_master_id", "app_document_id"], name: "idx_on_app_document_tag_master_id_app_document_id_75ee747154",
                                                         unique: true,
    )
  end
  ...
  create_table "com_document_tags", force: :cascade do |t|
    ...
    t.index(
      ["com_document_tag_master_id", "com_document_id"], name: "idx_on_com_document_tag_master_id_com_document_id_93b8da9f9e",
                                                         unique: true,
    )
  end
  ...
  create_table "org_document_tags", force: :cascade do |t|
    ...
    t.index(
      ["org_document_tag_master_id", "org_document_id"], name: "idx_on_org_document_tag_master_id_org_document_id_048a2b05e4",
                                                         unique: true,
    )
  end
  ...
  add_foreign_key "app_timeline_categories", "app_timeline_category_masters",
                  name: "fk_app_timeline_categories_on_app_timeline_category_master_id"
  ...
  add_foreign_key "app_timeline_category_masters", "app_timeline_category_masters", column: "parent_id",
                                                                                    name: "fk_app_timeline_category_masters_parent"
  ...
  add_foreign_key "com_timeline_categories", "com_timeline_category_masters",
                  name: "fk_com_timeline_categories_on_com_timeline_category_master_id"
  ...
  add_foreign_key "com_timeline_category_masters", "com_timeline_category_masters", column: "parent_id",
                                                                                    name: "fk_com_timeline_category_masters_parent"
  ...
  add_foreign_key "org_timeline_categories", "org_timeline_category_masters",
                  name: "fk_org_timeline_categories_on_org_timeline_category_master_id"
  ...
  add_foreign_key "org_timeline_category_masters", "org_timeline_category_masters", column: "parent_id",
                                                                                    name: "fk_org_timeline_category_masters_parent"
