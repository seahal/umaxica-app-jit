...
Jit::Identity::Engine.routes.draw do
  # Identity/Sign routes - Authentication, passkeys, OIDC, and social login
  # These endpoints require permanent URL stability

  require Rails.root.join("lib/sign_host_env").to_s if Rails.root.join("lib/sign_host_env.rb").exist?
  ...
  scope module: :sign, as: :sign do
    ...
    constraints host: SignHostEnv.dev_url do
    ...
    constraints host: SignHostEnv.net_url do
