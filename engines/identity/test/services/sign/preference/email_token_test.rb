      ...
      module Preference
        class EmailTokenTest < ActiveSupport::TestCase
          test "issue and parse round-trip" do
            ...
            result = Jit::Identity::Sign::Preference::EmailToken.parse(token, audience: "app")
          ...
          test "parse rejects wrong audience" do
            ...
            result = Jit::Identity::Sign::Preference::EmailToken.parse(token, audience: "org")

            assert_nil result
          end

          test "parse returns nil for blank token" do
            assert_nil Jit::Identity::Sign::Preference::EmailToken.parse("", audience: "app")
            assert_nil Jit::Identity::Sign::Preference::EmailToken.parse(nil, audience: "app")
          end

          test "parse returns nil for tampered token" do
            assert_nil Jit::Identity::Sign::Preference::EmailToken.parse("tampered-garbage", audience: "app")
          end
