...
class WithdrawalGateTest < ActionDispatch::IntegrationTest
  ...
  test "deactivated user accessing normal page redirects to configuration edit" do
    get Rails.application.routes.url_helpers.sign_identity.app_configuration_sessions_url(ri: "jp"), headers: @headers

    assert_response :redirect
    assert_redirected_to identity.edit_sign_app_configuration_path(ri: "jp")
  end

  test "deactivated user can access allowlisted pages" do
    get identity.new_sign_app_configuration_withdrawal_url(ri: "jp"), headers: @headers

    assert_response :success

    get identity.edit_sign_app_configuration_url(ri: "jp"), headers: @headers

    assert_response :success
  end

  test "deactivated user accessing API returns 403" do
    get identity.sign_app_configuration_sessions_url(ri: "jp"), headers: @headers.merge("Accept" => "application/json")
  ...
  test "normal user can access pages without withdrawal gate" do
    ...
    get identity.sign_app_configuration_sessions_url(ri: "jp"), headers: headers
