      ...
      module Webauthn
        class ConfigTest < ActiveSupport::TestCase
          ...
          test "validate_webauthn_origin! raises error for untrusted origin" do
            ...
            assert_raises(Jit::Identity::Sign::Webauthn::OriginValidationError) do
          ...
          test "challenge management flow" do
            ...
            challenges = @controller.session[Jit::Identity::Sign::Webauthn::CHALLENGE_SESSION_KEY]
          ...
          test "fetch_and_delete_challenge! raises error on wrong purpose" do
            ...
            assert_raises(Jit::Identity::Sign::Webauthn::ChallengePurposeMismatchError) do
          ...
          test "fetch_and_delete_challenge! raises error when expired" do
            ...
            assert_raises(Jit::Identity::Sign::Webauthn::ChallengeExpiredError) do
