...
module Jit
  module Identity
    ...
    module Jit::Identity::Sign::App::In::Passkey
      class AuthenticationFlowTest < ActionDispatch::IntegrationTest
        ...
        test "should generate authentication options and store challenge in session" do
          ...
          post identity.options_sign_app_in_passkeys_url(ri: "jp"), params: options_params(identifier: email), as: :json
        ...
        test "should verify valid credential and log in" do
          ...
          WebAuthn::Credential.stub(:from_get, mock_credential) do
            post identity.verification_sign_app_in_passkeys_url(ri: "jp"), params: {
