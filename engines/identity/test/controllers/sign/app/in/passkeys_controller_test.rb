  ...
  module Identity
    ...
    module Jit::Identity::Sign::App::In
      class PasskeysControllerTest < ActionDispatch::IntegrationTest
        # Include URL helpers for both main app and this engine
        include Rails.application.routes.url_helpers
        include Jit::Identity::Engine.routes.url_helpers
        ...
        test "options returns error if identifier not found" do
          post identity.options_sign_app_in_passkeys_path(ri: "jp"),
        ...
        test "options returns challenge and allowCredentials for email identifier" do
          ...
          post identity.options_sign_app_in_passkeys_path(ri: "jp"), params: options_params(identifier: email)
        ...
        test "verification logs user in on success" do
          ...
          WebAuthn::Credential.stub(:from_get, mock_credential) do
            ...
            # Should log in
            post identity.verification_sign_app_in_passkeys_path(ri: "jp", rd: "/configuration/emails"), params: params
            ...
            assert_equal sign_app_configuration_path(ri: "jp"), json["identity.redirect_url"]
        ...
        test "verification with session limit exceeded returns session_restricted" do
          ...
          WebAuthn::Credential.stub(:from_get, mock_credential) do
            ...
            post identity.verification_sign_app_in_passkeys_path(ri: "jp"), params: params

            assert_response :ok
            json = response.parsed_body

            assert_equal "session_restricted", json["status"]
            assert_equal sign_app_in_session_path(ri: "jp"), json["identity.redirect_url"]
        ...
        test "verification returns same response for credential mismatch and missing verified pii" do
          ...
          post identity.verification_sign_app_in_passkeys_path(ri: "jp"), params: {
          ...
          post identity.options_sign_app_in_passkeys_path(ri: "jp"), params: options_params(identifier: email.address)
        ...
        test "options returns turnstile error when response token is missing" do
          ...
          post identity.options_sign_app_in_passkeys_path(ri: "jp"), params: { identifier: @user_email.address }
