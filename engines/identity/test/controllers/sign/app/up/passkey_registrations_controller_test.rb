...
module Jit
  module Identity
    ...
    module Jit::Identity::Sign::App::Up
      class PasskeyRegistrationsControllerTest < ActionDispatch::IntegrationTest
        ...
        test "GET show returns 200 with passkey endpoint data attrs" do
          ...
          identity.begin_path = identity.begin_sign_app_up_telephone_passkey_registration_path(telephone, ri: "jp")

          assert_select "[data-passkey-registration-begin-url-value='#{identity.begin_path}']"
          identity.finish_path = sign_app_up_telephone_passkey_registration_path(telephone, ri: "jp")

          assert_select "[data-passkey-registration-finish-url-value='#{identity.finish_path}']"
        ...
        test "POST begin returns challenge and options" do
          ...
          post identity.begin_sign_app_up_telephone_passkey_registration_url(telephone, ri: "jp")
        ...
        test "POST create saves passkey and returns completion redirect on success" do
          ...
          assert_equal sign_app_configuration_path(ri: "jp"), response.parsed_body["identity.redirect_url"]
        ...
        test "POST create respects rt parameter for redirect" do
          ...
          assert_equal sign_app_configuration_path(ri: "jp"),
                       response.parsed_body["identity.redirect_url"]
        end
