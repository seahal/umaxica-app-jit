...
class CustomerSecret < GuestRecord
  ...
  IDENTITY_SIGN_IN_ALLOWED_STATUS_IDS = [CustomerSecretStatus::ACTIVE].freeze
  IDENTITY_SIGN_IN_ALLOWED_KIND_IDS = CustomerSecretKind::ALLOWED_FOR_SECRET_SIGN_IN
  ...
  scope :allowed_for_secret_sign_in, lambda {
    where(
      customer_secret_status_id: IDENTITY_SIGN_IN_ALLOWED_STATUS_IDS,
      customer_secret_kind_id: IDENTITY_SIGN_IN_ALLOWED_KIND_IDS,
    )
  }
  ...
  def sign_in_status_allowed?
    IDENTITY_SIGN_IN_ALLOWED_STATUS_IDS.include?(customer_secret_status_id)
  end

  def sign_in_kind_allowed?
    IDENTITY_SIGN_IN_ALLOWED_KIND_IDS.include?(customer_secret_kind_id)
  end
