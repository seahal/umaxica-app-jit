...
class StaffSecret < OperatorRecord
  ...
  IDENTITY_SIGN_IN_ALLOWED_STATUS_IDS = [StaffSecretStatus::ACTIVE].freeze
  IDENTITY_SIGN_IN_ALLOWED_KIND_IDS = StaffSecretKind::ALLOWED_FOR_SECRET_SIGN_IN
  ...
  scope :allowed_for_secret_sign_in, lambda {
    where(
      staff_identity_secret_status_id: IDENTITY_SIGN_IN_ALLOWED_STATUS_IDS,
      staff_secret_kind_id: IDENTITY_SIGN_IN_ALLOWED_KIND_IDS,
    )
  }
  ...
  def sign_in_status_allowed?
    IDENTITY_SIGN_IN_ALLOWED_STATUS_IDS.include?(staff_secret_status_id)
  end

  def sign_in_kind_allowed?
    IDENTITY_SIGN_IN_ALLOWED_KIND_IDS.include?(staff_secret_kind_id)
  end
