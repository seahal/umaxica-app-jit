...
module Preference
  ...
  class StorageAdapter
    ...
    class PreferenceWrapper
      ...
      def option_id_to_language(option_id, _prefix)
      ...
      def option_id_to_region(option_id, _prefix)
        return if option_id.blank?
      ...
      def option_id_to_timezone(option_id, _prefix)
        return if option_id.blank?
      ...
      def option_id_to_colortheme(option_id, _prefix)
        return if option_id.blank?
