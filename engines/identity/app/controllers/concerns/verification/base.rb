...
module Verification
  module Base
    ...
    def actor_verification_path(attrs)
      actor_staff? ? identity.sign_org_verification_path(attrs) : identity.sign_app_verification_path(attrs)
    end
    ...
    def verification_setup_redirect_path
      ...
      actor_staff? ? identity.new_sign_org_verification_setup_path(attrs) : identity.new_sign_app_verification_setup_path(attrs)
    end
