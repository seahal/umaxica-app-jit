...
module Authentication
  module Base
    ...
    def refresh_access_token(refresh_plain)
      ...
      result = Jit::Identity::Sign::RefreshTokenService.call(refresh_token: refresh_plain)
    ...
    rescue Jit::Identity::Sign::InvalidRefreshToken => e
    ...
    def populate_current_attributes!(resource, payload)
      ...
      Current.domain = Foundation::Surface.current(request) if respond_to?(:request, true) && request.present?
    end
