    ...
    module Sign
      module OrgVerificationBase
        ...
        class_methods do
          ...
          def activate_org_verification_base
            ...
            define_method(:handle_invalid_reauth_session!) do
              clear_reauth_state!
              safe_redirect_to(
                identity.sign_org_configuration_path(ri: params[:ri]),
            ...
            define_method(:verification_success_fallback_path) { identity.sign_org_verification_path(ri: params[:ri]) }
        ...
        def verification_unavailable_redirect_path
          identity.sign_org_verification_path(ri: params[:ri])
        end
