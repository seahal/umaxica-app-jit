          ...
          module Challenge
            class PasskeysController < ApplicationController
              ...
              def new
                ...
                if passkeys.empty?
                  redirect_to(
                    identity.sign_com_in_challenge_path(ri: params[:ri]),
              ...
              def create
                unless cloudflare_turnstile_stealth_validation["success"]
                  redirect_to(
                    identity.new_sign_com_in_challenge_passkey_path(ri: params[:ri]),
                    alert: I18n.t(
              ...
              def complete_mfa_login!(customer)
                ...
                when :success
                  if issue_bulletin!
                    redirect_to(
                      identity.sign_com_in_bulletin_path(rd: result[:redirect_path], ri: params[:ri]),
