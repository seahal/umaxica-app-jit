      ...
      module AppVerificationBase
        ...
        class_methods do
          def activate_app_verification_base
            ...
            include Jit::Identity::Sign::VerificationTiming
            include Jit::Identity::Sign::VerificationCommonBase
            include Jit::Identity::Sign::VerificationAuditAndCookie
            include Jit::Identity::Sign::VerificationReauthSessionStore
            include Jit::Identity::Sign::VerificationReauthLifecycle
            include Jit::Identity::Sign::VerificationPasskeyChecks
            include Jit::Identity::Sign::VerificationTotpChecks
        ...
        def handle_invalid_reauth_session!
          ...
          safe_redirect_to(
            identity.sign_app_verification_path(verification_recovery_redirect_params),
            fallback: identity.sign_app_verification_path(ri: params[:ri]),
        ...
        def verification_unavailable_redirect_path
          identity.sign_app_verification_path(ri: params[:ri])
        end
