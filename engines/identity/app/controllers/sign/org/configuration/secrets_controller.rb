      ...
      module Org
        module Configuration
          class SecretsController < ApplicationController
            ...
            before_action :set_secret_or_404, only: []
            ...
            def create
              ...
              redirect_to(identity.sign_org_configuration_secrets_path)
            ...
            def destroy
              ...
              redirect_to(identity.sign_org_configuration_secrets_path, status: :see_other)
            end
