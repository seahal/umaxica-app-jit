          ...
          class PasskeysController < ApplicationController
            ...
            def create
              respond_to do |format|
                format.html do
                  redirect_to(
                    identity.new_sign_org_configuration_passkey_path,
            ...
            def verification
              ...
              with_challenge(challenge_id, purpose: :registration) do |challenge|
                ...
                render json: {
                  ...
                  redirect_url: identity.sign_org_configuration_passkeys_path,
                }, status: :created
              end
            ...
            def update
              if @passkey.update(update_params)
                respond_to do |format|
                  format.html do
                    redirect_to(
                      identity.sign_org_configuration_passkey_path(@passkey),
            ...
            def destroy
              ...
              respond_to do |format|
                format.html do
                  redirect_to(
                    identity.sign_org_configuration_passkeys_path,
                    status: :see_other,
