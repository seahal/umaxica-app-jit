      ...
      module Org
        module In
          ...
          class PasskeysController < ApplicationController
            ...
            include Jit::Identity::Sign::PasskeyAuthentication
            include Jit::Identity::Sign::PasskeyAuthenticationHelpers
            include Jit::Identity::Sign::PasskeyOptionsFlow
            include Jit::Identity::Sign::PasskeyVerificationFlow
            include Jit::Identity::Sign::PasskeySignInFlow
            include Jit::Identity::Sign::PasskeyLoginResultFlow
            ...
            def handle_domain_specific_login_status(result)
              case result[:status]
              when :totp_required
                render json: { status: "totp_required", redirect_url: identity.new_sign_org_in_totp_path }, status: :ok
                true
              ...
              when :session_limit_exceeded
                ...
                render json: {
                  ...
                  redirect_url: identity.new_sign_org_in_passkey_path,
                }, status: :ok
                true
              else
                false
            ...
            def render_passkey_restricted_success(_result)
              render json: {
                ...
                redirect_url: identity.sign_org_in_session_path,
              }, status: :ok
            end

            def passkey_bulletin_redirect_url
              identity.sign_org_in_bulletin_path(rd: retrieve_redirect_parameter_for_bulletin, ri: params[:ri])
            end
