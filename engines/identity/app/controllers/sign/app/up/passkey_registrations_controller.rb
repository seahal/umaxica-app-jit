          ...
          class PasskeyRegistrationsController < ApplicationController
            ...
            def create
              ...
              with_challenge(challenge_id, purpose: :registration) do |challenge|
                ...
                render json: {
                  status: "ok",
                  redirect_url: has_bulletin ? success_redirect_url : identity.sign_app_configuration_path(ri: params[:ri]),
                }, status: :created
              end
            rescue Jit::Identity::Sign::Webauthn::ChallengeNotFoundError,
                   Jit::Identity::Sign::Webauthn::ChallengeExpiredError,
                   Jit::Identity::Sign::Webauthn::ChallengePurposeMismatchError => e
            ...
            def set_user_telephone
              ...
              if @user_telephone.user_telephone_status_id != UserTelephoneStatus::VERIFIED_WITH_SIGN_UP
                if request.format.json?
                  ...
                  redirect_to(identity.edit_sign_app_up_telephone_path(@user_telephone, ri: params[:ri]))
                end
                return
              end
            ...
            def success_redirect_url
              ...
              identity.sign_app_in_bulletin_path(rd: rd_param, ri: params[:ri])
            end
          end
        end
      end
