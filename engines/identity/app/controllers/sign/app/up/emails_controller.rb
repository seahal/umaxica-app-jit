      ...
      module App
        module Up
          class EmailsController < ApplicationController
            include Jit::Identity::Sign::EmailRegistrable
            ...
            def edit
              ...
              if @user_email.blank?
                reset_email_flow!
                redirect_to(
                  identity.new_sign_app_up_email_path,
              ...
              redirect_to(identity.new_sign_app_up_email_path(redirect_params))
              nil
            end
            ...
            def create
              ...
              redirect_to(identity.edit_sign_app_up_email_path(@user_email, redirect_params))
            end
            ...
            def handle_locked_result
              ...
              redirect_to(identity.new_sign_app_up_email_path)
            end
            ...
            def session_existing_email_id
              session[Jit::Identity::Sign::EmailRegistrable::EXISTING_EMAIL_SESSION_KEY]
            end

            def existing_signup_skip_otp?
              session[Jit::Identity::Sign::EmailRegistrable::EXISTING_EMAIL_SKIP_OTP_SESSION_KEY] == true
            end
            ...
            def handle_existing_email_verification(submitted_code)
              ...
              reset_email_flow!
              session.delete(Jit::Identity::Sign::EmailRegistrable::EXISTING_EMAIL_SESSION_KEY)
              redirect_to(
                identity.new_sign_app_in_path,
                notice: t("sign.app.registration.email.update.sign_in_required"),
              )
