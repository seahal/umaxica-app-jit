    ...
    module Sign
      module App
        module Social
          ...
          #   Jit::Identity::Sign::App::Auth::OmniauthCallbacksController
          class SessionsController < Jit::Identity::Sign::App::ApplicationController
            ...
            def new
              ...
              safe_redirect_to(
                ...
                fallback: identity.new_sign_app_in_path,
              )
            ...
            def unlink
              ...
              redirect_to(
                identity.sign_app_configuration_path,
                notice: I18n.t(
              ...
              redirect_to(identity.sign_app_configuration_path, alert: e.message)
            end
