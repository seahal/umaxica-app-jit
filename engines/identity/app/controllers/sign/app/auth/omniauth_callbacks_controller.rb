    ...
    module Sign
      module App
        module Auth
          ...
          class OmniauthCallbacksController < Jit::Identity::Sign::App::ApplicationController
            ...
            def failure
              ...
              redirect_to(identity.new_sign_app_in_path, alert: alert_message)
            end
            ...
            def redirect_for_existing_account(provider_name)
              if issue_bulletin!
                redirect_to(
                  identity.sign_app_in_bulletin_path(ri: params[:ri]),
                  notice: I18n.t(
