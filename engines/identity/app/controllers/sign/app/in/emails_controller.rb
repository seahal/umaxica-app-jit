        ...
        module In
          class EmailsController < ApplicationController
            ...
            def create
              ...
              redirect_to(identity.edit_sign_app_in_email_path(rd: peek_redirect_parameter))
            end
            ...
            def load_user_email
              if session[:user_email_authentication_id].present?
                ...
                unless @user_email
                  ...
                  redirect_to(identity.new_sign_app_in_email_path(rd: peek_redirect_parameter))
                  return
                end
            ...
            def verify_existing_email_otp(user_email)
              ...
              if result[:success]
                ...
                if result[:status] == :mfa_required
                  ...
                  { success: true, restricted: true, redirect_path: identity.sign_app_in_session_path }
