    ...
    module Sign
      module App
        module Configuration
          module Telephones
            class RegistrationsController < ::Jit::Identity::Sign::App::ApplicationController
              auth_required!

              include Jit::Identity::Sign::TelephoneRegistrable
              ...
              def edit
                ...
                reset_registration_session!
                redirect_to(
                  identity.new_sign_app_configuration_telephones_registration_path,
              ...
              def create
                ...
                redirect_to(
                  identity.edit_sign_app_configuration_telephones_registration_path,
              ...
              def update
                ...
                when :success
                  reset_registration_session!
                  redirect_to(
                    identity.sign_app_configuration_telephones_path,
                ...
                when :locked
                  ...
                  redirect_to(identity.new_sign_app_configuration_telephones_registration_path)
                else
                  render :edit, status: :unprocessable_content
                end
              end
