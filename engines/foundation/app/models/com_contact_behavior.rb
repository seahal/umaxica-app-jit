...
class ComContactBehavior < BehaviorRecord
  ...
  validates_reference_table :event_id, association: :com_contact_behavior_event
  validates_reference_table :level_id, association: :com_contact_behavior_level
