...
module Jit
  module Foundation
    ...
    class Jit::Foundation::Base::Com::Auth::CallbacksControllerTest < ActionDispatch::IntegrationTest
      setup do
        @host = ENV.fetch("FOUNDATION_BASE_COM_URL", "base.com.localhost")
      end

      test "returns client_id as core_com" do
        controller = Jit::Foundation::Base::Com::Auth::CallbacksController.new
