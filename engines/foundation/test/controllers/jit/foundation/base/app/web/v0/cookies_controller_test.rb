...
module Jit
  module Foundation
    ...
    class Jit::Foundation::Base::App::Web::V0::CookiesControllerTest < ActionDispatch::IntegrationTest
      ...
      test "GET show without access jwt returns consented false" do
        ...
        get foundation.base_app_web_v0_cookie_path, as: :json
      ...
      test "PATCH update with consented true updates preference cookie and issues access token" do
        ...
        with_preference_jwt_keys(host: @host) do
          patch foundation.base_app_web_v0_cookie_path, params: { consented: true }, as: :json
        end
        ...
        assert_includes set_cookie, "#{Preference::IoKeys::Cookies::CONSENTED}=1"
