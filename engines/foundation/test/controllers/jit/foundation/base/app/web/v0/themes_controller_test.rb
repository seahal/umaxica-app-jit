...
module Jit
  module Foundation
    ...
    class Jit::Foundation::Base::App::Web::V0::ThemesControllerTest < ActionDispatch::IntegrationTest
      ...
      test "GET show without access jwt returns default theme sy" do
        ...
        get foundation.base_app_web_v0_theme_path, as: :json
      ...
      test "PATCH update sets theme cookie and returns updated theme" do
        ...
        with_preference_jwt_keys(host: @host) do
          patch foundation.base_app_web_v0_theme_path, params: { theme: "light" }, as: :json
        end
      ...
      test "PATCH update with preference record updates colortheme and rotates access token" do
        ...
        AppPreferenceColortheme.create!(preference: preference, option_id: option_class::SYSTEM)
        ...
        assert_equal option_class::LIGHT, preference.app_preference_colortheme.option_id
