...
class RenamePrincipalIdentityColumns < ActiveRecord::Migration[8.2]
  ...
  def up
    safety_assured do
      ...
      safe_rename_column :user_one_time_passwords, :user_identity_one_time_password_status_id, :user_one_time_password_status_id
    end
  end
  ...
  def down
    safety_assured do
      ...
      safe_rename_column :user_one_time_passwords, :user_one_time_password_status_id, :user_identity_one_time_password_status_id
    end
  end
