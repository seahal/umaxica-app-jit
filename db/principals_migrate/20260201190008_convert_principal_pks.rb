...
class ConvertPrincipalPks < ActiveRecord::Migration[8.0]
  def up
    ...
    add_foreign_key "user_one_time_passwords", "user_one_time_password_statuses", column: "user_identity_one_time_password_status_id", validate: false
    ...
    add_foreign_key "user_social_apples", "user_social_apple_statuses", column: "user_identity_social_apple_status_id", validate: false
    add_foreign_key "user_social_apples", "users", validate: false
    add_foreign_key "user_social_googles", "user_social_google_statuses", column: "user_identity_social_google_status_id", validate: false
    add_foreign_key "user_social_googles", "users", validate: false
    add_foreign_key "user_telephones", "user_telephone_statuses", column: "user_identity_telephone_status_id", validate: false
