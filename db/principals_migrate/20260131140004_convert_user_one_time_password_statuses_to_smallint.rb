class ConvertUserOneTimePasswordStatusesToSmallint < ActiveRecord::Migration[8.2]
  def up
    safety_assured do
      ...
      execute "ALTER TABLE user_one_time_password_statuses DROP CONSTRAINT user_one_time_password_statuses_pkey CASCADE"
      ...
      add_check_constraint :user_one_time_password_statuses, "id >= 0", name: "user_one_time_password_statuses_id_non_negative"

      add_column :user_one_time_passwords, :user_identity_one_time_password_status_id_small, :integer, limit: 2, default: 1
      execute <<~SQL.squish
      ...
      rename_column :user_one_time_passwords, :user_identity_one_time_password_status_id_small, :user_identity_one_time_password_status_id
      ...
      add_index :user_one_time_passwords, :user_identity_one_time_password_status_id, name: "idx_on_user_identity_one_time_password_status_id_c03cdf0b39"
      add_check_constraint :user_one_time_passwords, "user_identity_one_time_password_status_id >= 0", name: "user_one_time_passwords_user_identity_one_time_password_status_id_non_negative"
