class ConvertUserSocialAppleStatusesToSmallint < ActiveRecord::Migration[8.2]
  def up
    safety_assured do
      ...
      execute "ALTER TABLE user_social_apple_statuses DROP CONSTRAINT user_social_apple_statuses_pkey CASCADE"
      ...
      rename_column :user_social_apples, :user_identity_social_apple_status_id_small, :user_identity_social_apple_status_id
      ...
      add_index :user_social_apples, :user_identity_social_apple_status_id, name: "idx_on_user_identity_social_apple_status_id_93441f369d"
      add_check_constraint :user_social_apples, "user_identity_social_apple_status_id >= 0", name: "user_social_apples_user_identity_social_apple_status_id_non_negative"
