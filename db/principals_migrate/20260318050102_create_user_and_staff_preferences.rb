...
class CreateUserAndStaffPreferences < ActiveRecord::Migration[8.1]
  def change # rubocop:disable Metrics/AbcSize,Metrics/MethodLength
    ...
    create_table :user_preference_language_options do |t|
    end

    create_table :user_preference_timezone_options do |t|
    end

    create_table :user_preference_region_options do |t|
    end

    create_table :user_preference_colortheme_options do |t|
    end
    ...
    create_table :staff_preference_language_options do |t|
    end

    create_table :staff_preference_timezone_options do |t|
    end

    create_table :staff_preference_region_options do |t|
    end

    create_table :staff_preference_colortheme_options do |t|
    end
