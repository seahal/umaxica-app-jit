...
class AddOptionsToOrgPreferenceChildren < ActiveRecord::Migration[8.2]
  ...
  def change
    add_column :org_preference_languages, :option_id, :uuid
    ...
    add_column :org_preference_regions, :option_id, :uuid
    ...
    add_column :org_preference_timezones, :option_id, :uuid
    ...
    add_column :org_preference_colorthemes, :option_id, :uuid
