...
class CreatePreferenceBindingMethodsAndDbscStatuses < ActiveRecord::Migration[8.2]
  ...
  def change
    ...
    add_foreign_key :app_preferences, :app_preference_binding_methods, column: :binding_method_id,
                                                                       name: "fk_app_preferences_on_binding_method_id",
                                                                       validate: false
    add_foreign_key :app_preferences, :app_preference_dbsc_statuses, column: :dbsc_status_id,
    ...
    add_foreign_key :org_preferences, :org_preference_binding_methods, column: :binding_method_id,
                                                                       name: "fk_org_preferences_on_binding_method_id",
                                                                       validate: false
    add_foreign_key :org_preferences, :org_preference_dbsc_statuses, column: :dbsc_status_id,
    ...
    add_foreign_key :com_preferences, :com_preference_binding_methods, column: :binding_method_id,
                                                                       name: "fk_com_preferences_on_binding_method_id",
                                                                       validate: false
    add_foreign_key :com_preferences, :com_preference_dbsc_statuses, column: :dbsc_status_id,
