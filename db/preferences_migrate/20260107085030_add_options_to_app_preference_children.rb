...
class AddOptionsToAppPreferenceChildren < ActiveRecord::Migration[8.2]
  ...
  def change
    ...
    add_column :app_preference_timezones, :option_id, :string unless column_exists?(:app_preference_timezones, :option_id)
    ...
    add_column :app_preference_colorthemes, :option_id, :string unless column_exists?(:app_preference_colorthemes, :option_id)
