...
class ConvertAllPreferencePksToBigint < ActiveRecord::Migration[8.2]
  def up
    ...
    drop_table :app_preference_statuses, if_exists: true
    drop_table :com_preference_statuses, if_exists: true
    drop_table :org_preference_statuses, if_exists: true
    drop_table :app_preference_language_options, if_exists: true
    drop_table :com_preference_language_options, if_exists: true
    drop_table :org_preference_language_options, if_exists: true
    drop_table :app_preference_region_options, if_exists: true
    drop_table :com_preference_region_options, if_exists: true
    drop_table :org_preference_region_options, if_exists: true
    drop_table :app_preference_timezone_options, if_exists: true
    drop_table :com_preference_timezone_options, if_exists: true
    drop_table :org_preference_timezone_options, if_exists: true
    drop_table :app_preference_colortheme_options, if_exists: true
    drop_table :com_preference_colortheme_options, if_exists: true
    drop_table :org_preference_colortheme_options, if_exists: true
