...
ActiveRecord::Schema[8.2].define(version: 2026_01_09_141216) do
  ...
  create_table "avatar_membership_statuses", id: :string, force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.check_constraint "id::text ~ '^[A-Z0-9_]+$'::text", name: "avatar_membership_statuses_id_format_check"
  end
  ...
  create_table "avatar_moniker_statuses", id: :string, force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.check_constraint "id::text ~ '^[A-Z0-9_]+$'::text", name: "avatar_moniker_statuses_id_format_check"
  end
  ...
  create_table "avatar_ownership_statuses", id: :string, force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.check_constraint "id::text ~ '^[A-Z0-9_]+$'::text", name: "avatar_ownership_statuses_id_format_check"
  end
  ...
  create_table "handle_assignment_statuses", id: :string, force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.check_constraint "id::text ~ '^[A-Z0-9_]+$'::text", name: "handle_assignment_statuses_id_format_check"
  end
  ...
  create_table "handle_statuses", id: :string, force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.check_constraint "id::text ~ '^[A-Z0-9_]+$'::text", name: "handle_statuses_id_format_check"
  end
  ...
  create_table "post_review_statuses", id: :string, force: :cascade do |t|
    ...
    t.check_constraint "id::text ~ '^[A-Z0-9_]+$'::text", name: "post_review_statuses_id_format_check"
  end
  ...
  create_table "post_statuses", id: :string, force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.check_constraint "id::text ~ '^[A-Z0-9_]+$'::text", name: "post_statuses_id_format_check"
  end
