...
class ConvertAllNewsPksToBigint < ActiveRecord::Migration[8.2]
  def up
    ...
    drop_table :app_timeline_statuses, if_exists: true
    drop_table :com_timeline_statuses, if_exists: true
    drop_table :org_timeline_statuses, if_exists: true
    drop_table :app_timeline_category_masters, if_exists: true
    drop_table :com_timeline_category_masters, if_exists: true
    drop_table :org_timeline_category_masters, if_exists: true
    drop_table :app_timeline_tag_masters, if_exists: true
    drop_table :com_timeline_tag_masters, if_exists: true
    drop_table :org_timeline_tag_masters, if_exists: true
