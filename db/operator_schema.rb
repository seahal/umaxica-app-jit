...
ActiveRecord::Schema[8.2].define(version: 2026_01_24_230010) do
  ...
  create_table "admin_statuses", id: { type: :string, limit: 255, default: "NEYO" }, force: :cascade do |t|
    ...
    t.check_constraint "id::text ~ '^[A-Z0-9_]+$'::text", name: "admin_statuses_id_format_check"
  end
  ...
  create_table "division_statuses", id: { type: :string, limit: 255 }, force: :cascade do |t|
    ...
    t.check_constraint "id::text ~ '^[A-Z0-9_]+$'::text", name: "division_statuses_id_format_check"
  end
  ...
  create_table "organization_statuses", id: { type: :string, limit: 255 }, force: :cascade do |t|
    ...
    t.check_constraint "id::text ~ '^[A-Z0-9_]+$'::text", name: "organization_statuses_id_format_check"
  end
  ...
  create_table "staff_email_statuses", id: { type: :string, limit: 255, default: "UNVERIFIED" }, force: :cascade do |t|
    ...
    t.check_constraint "id::text ~ '^[A-Z0-9_]+$'::text", name: "staff_email_statuses_id_format_check"
  end
  ...
  create_table "staff_passkey_statuses", id: { type: :string, limit: 255 }, force: :cascade do |t|
    ...
    t.check_constraint "id::text ~ '^[A-Z0-9_]+$'::text", name: "staff_passkey_statuses_id_format_check"
  end
  ...
  create_table "staff_secret_statuses", id: { type: :string, limit: 255 }, force: :cascade do |t|
    ...
    t.check_constraint "id::text ~ '^[A-Z0-9_]+$'::text", name: "staff_secret_statuses_id_format_check"
  end
  ...
  create_table "staff_statuses", id: { type: :string, limit: 255, default: "NEYO" }, force: :cascade do |t|
    ...
    t.check_constraint "id::text ~ '^[A-Z0-9_]+$'::text", name: "staff_statuses_id_format_check"
  end
  ...
  create_table "staff_telephone_statuses", id: { type: :string, limit: 255, default: "UNVERIFIED" }, force: :cascade do |t|
    ...
    t.check_constraint "id::text ~ '^[A-Z0-9_]+$'::text", name: "staff_telephone_statuses_id_format_check"
  end
  ...
  create_table "workspace_statuses", id: { type: :string, limit: 255 }, force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.check_constraint "id::text ~ '^[A-Z0-9_]+$'::text", name: "workspace_statuses_id_format_check"
  end
