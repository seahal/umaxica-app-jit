...
class ConvertTimelineMastersToBigint < ActiveRecord::Migration[8.2]
  ...
  REFERENCING_TABLES = {
    ...
    "org_timeline_category_masters" => [{ table: "org_timeline_categories", column: "org_timeline_category_master_id" }],
    ...
    "com_timeline_category_masters" => [{ table: "com_timeline_categories", column: "com_timeline_category_master_id" }],
    ...
    "app_timeline_category_masters" => [{ table: "app_timeline_categories", column: "app_timeline_category_master_id" }],
  }.freeze
