...
class SeedTestTokens < ActiveRecord::Migration[8.2]
  ...
  USER_TOKENS = [
    { id: "00000000-0000-0000-0000-000000200001",
      ...
      public_id: "utoken_one", },
    { id: "00000000-0000-0000-0000-000000200002",
      user_id: "00000000-0000-0000-0000-000000000002",
      public_id: "utoken_two", },
  ].freeze

  STAFF_TOKENS = [
    { id: "00000000-0000-0000-0000-000000210001",
      staff_id: "00000000-0000-0000-0000-000000100001",
      public_id: "stoken_one", },
    { id: "00000000-0000-0000-0000-000000210002",
      staff_id: "00000000-0000-0000-0000-000000100001",
      public_id: "stoken_two", },
  ].freeze
