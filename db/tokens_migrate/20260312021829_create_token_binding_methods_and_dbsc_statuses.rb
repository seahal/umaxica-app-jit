...
class CreateTokenBindingMethodsAndDbscStatuses < ActiveRecord::Migration[8.2]
  ...
  def change
    ...
    add_foreign_key :user_tokens, :user_token_binding_methods,
                    name: "fk_user_tokens_on_user_token_binding_method_id",
                    validate: false
    add_foreign_key :user_tokens, :user_token_dbsc_statuses,
    ...
    add_foreign_key :staff_tokens, :staff_token_binding_methods,
                    name: "fk_staff_tokens_on_staff_token_binding_method_id",
                    validate: false
    add_foreign_key :staff_tokens, :staff_token_dbsc_statuses,
