...
ActiveRecord::Schema[8.2].define(version: 2026_02_04_000001) do
  ...
  add_foreign_key "app_preference_audits", "app_preference_audit_events", column: "event_id", validate: false
  add_foreign_key "app_preference_audits", "app_preference_audit_levels", column: "level_id", validate: false
  ...
  add_foreign_key "com_preference_audits", "com_preference_audit_events", column: "event_id", validate: false
  add_foreign_key "com_preference_audits", "com_preference_audit_levels", column: "level_id", validate: false
  ...
  add_foreign_key "org_preference_audits", "org_preference_audit_events", column: "event_id", validate: false
  add_foreign_key "org_preference_audits", "org_preference_audit_levels", column: "level_id", validate: false
  ...
  add_foreign_key "staff_audits", "staff_audit_events", column: "event_id", validate: false
  add_foreign_key "staff_audits", "staff_audit_levels", column: "level_id", validate: false
  add_foreign_key "user_audits", "user_audit_events", column: "event_id", validate: false
  add_foreign_key "user_audits", "user_audit_levels", column: "level_id", validate: false
end
