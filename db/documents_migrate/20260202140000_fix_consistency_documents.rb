...
class FixConsistencyDocuments < ActiveRecord::Migration[8.2]
  def up
    safety_assured do
      ...
      add_reference :org_document_category_masters, :parent, foreign_key: { to_table: :org_document_category_masters }, index: true, null: true
      ...
      add_reference :org_document_tag_masters, :parent, foreign_key: { to_table: :org_document_tag_masters }, index: true, null: true
      ...
      add_reference :com_document_category_masters, :parent, foreign_key: { to_table: :com_document_category_masters }, index: true, null: true
      ...
      add_reference :com_document_tag_masters, :parent, foreign_key: { to_table: :com_document_tag_masters }, index: true, null: true
      ...
      add_reference :app_document_category_masters, :parent, foreign_key: { to_table: :app_document_category_masters }, index: true, null: true
      ...
      add_reference :app_document_tag_masters, :parent, foreign_key: { to_table: :app_document_tag_masters }, index: true, null: true
