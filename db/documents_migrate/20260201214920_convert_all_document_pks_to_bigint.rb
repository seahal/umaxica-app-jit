...
class ConvertAllDocumentPksToBigint < ActiveRecord::Migration[8.2]
  def up
    ...
    drop_table :app_document_statuses, if_exists: true
    drop_table :com_document_statuses, if_exists: true
    drop_table :org_document_statuses, if_exists: true
    drop_table :app_document_category_masters, if_exists: true
    drop_table :com_document_category_masters, if_exists: true
    drop_table :org_document_category_masters, if_exists: true
    drop_table :app_document_tag_masters, if_exists: true
    drop_table :com_document_tag_masters, if_exists: true
    drop_table :org_document_tag_masters, if_exists: true
