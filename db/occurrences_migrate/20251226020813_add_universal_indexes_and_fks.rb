...
class AddUniversalIndexesAndFks < ActiveRecord::Migration[8.2]
  def change
    ...
    add_index(
      :zip_occurrence_statuses, "lower(id)", unique: true, name: "index_zip_occurrence_statuses_on_lower_id",
                                             if_not_exists: true,
    )
    add_index(
      :user_occurrence_statuses, "lower(id)", unique: true, name: "index_user_occurrence_statuses_on_lower_id",
                                              if_not_exists: true,
    )
    add_index(
      :telephone_occurrence_statuses, "lower(id)", unique: true,
                                                   name: "index_telephone_occurrence_statuses_on_lower_id", if_not_exists: true,
    )
    add_index(
      :staff_occurrence_statuses, "lower(id)", unique: true,
                                               name: "index_staff_occurrence_statuses_on_lower_id", if_not_exists: true,
    )
    add_index(
      :ip_occurrence_statuses, "lower(id)", unique: true, name: "index_ip_occurrence_statuses_on_lower_id",
                                            if_not_exists: true,
    )
    add_index(
      :email_occurrence_statuses, "lower(id)", unique: true,
                                               name: "index_email_occurrence_statuses_on_lower_id", if_not_exists: true,
    )
    add_index(
      :domain_occurrence_statuses, "lower(id)", unique: true,
                                                name: "index_domain_occurrence_statuses_on_lower_id", if_not_exists: true,
    )
    add_index(
      :area_occurrence_statuses, "lower(id)", unique: true, name: "index_area_occurrence_statuses_on_lower_id",
                                              if_not_exists: true,
    )
