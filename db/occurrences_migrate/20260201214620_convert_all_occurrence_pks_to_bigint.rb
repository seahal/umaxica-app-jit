...
class ConvertAllOccurrencePksToBigint < ActiveRecord::Migration[8.2]
  def up
    ...
    drop_table :area_occurrence_statuses, if_exists: true
    drop_table :domain_occurrence_statuses, if_exists: true
    drop_table :email_occurrence_statuses, if_exists: true
    drop_table :ip_occurrence_statuses, if_exists: true
    drop_table :staff_occurrence_statuses, if_exists: true
    drop_table :telephone_occurrence_statuses, if_exists: true
    drop_table :user_occurrence_statuses, if_exists: true
    drop_table :zip_occurrence_statuses, if_exists: true
