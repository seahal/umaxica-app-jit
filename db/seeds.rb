...
ComContactStatus.create_or_find_by!(title: 'NONE', description: 'root of service site status inquiries', parent_title: nil)
ComContactStatus.create_or_find_by!(title: 'SET_UP', description: 'first step completed', parent_title: 'NONE')
