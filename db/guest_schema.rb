...
ActiveRecord::Schema[8.1].define(version: 2025_10_27_110200) do
  ...
  create_table "corporate_site_contact_emails", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.timestamptz "expires_at", default: "2025-10-28 12:16:20", null: false
  ...
  create_table "corporate_site_contact_telephones", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.index ["otp_expires_at"], name: "index_corporate_site_contact_telephones_on_otp_expires_at"
  end
