...
ActiveRecord::Schema[8.2].define(version: 2025_12_09_181000) do
  ...
  create_table "app_contact_emails", id: :string, force: :cascade do |t|
    ...
    t.timestamptz "expires_at", default: "2025-12-11 06:40:37", null: false
  ...
  create_table "app_contact_topics", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.boolean "deletable", default: false, null: false
    t.timestamptz "expires_at", default: "2025-12-11 06:40:39", null: false
  ...
  create_table "com_contact_emails", id: :string, force: :cascade do |t|
    ...
    t.boolean "deletable", default: false, null: false
    t.string "email_address", limit: 1000, default: "", null: false
    t.timestamptz "expires_at", default: "2025-12-11 06:40:38", null: false
