...
ActiveRecord::Schema[8.1].define(version: 2025_10_27_102307) do
  ...
  create_table "com_contact_emails", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.timestamptz "expires_at", default: "2025-11-11 13:12:45", null: false
  ...
  create_table "com_contact_telephones", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.boolean "activated", default: false, null: false
    t.uuid "com_contact_id", null: false
    t.datetime "created_at", null: false
    t.boolean "deletable", default: false, null: false
