...
class AddUniqueIndexesForComContactHasOne < ActiveRecord::Migration[8.2]
  ...
  def down
    remove_index :com_contact_emails, name: "index_com_contact_emails_on_com_contact_id_unique" if index_exists?(:com_contact_emails, nil, name: "index_com_contact_emails_on_com_contact_id_unique")
    remove_index :com_contact_telephones, name: "index_com_contact_telephones_on_com_contact_id_unique" if index_exists?(:com_contact_telephones, nil, name: "index_com_contact_telephones_on_com_contact_id_unique")
  end
end
