class CreateComContactTelephones < ActiveRecord::Migration[8.1]
  def change
    create_table :com_contact_telephones, id: :string do |t|
    ...
    add_index :com_contact_telephones, :verifier_expires_at
    add_index :com_contact_telephones, :telephone_number
  end
end
