...
class FixContactStatusFksNullify < ActiveRecord::Migration[8.2]
  disable_ddl_transaction!

  def up
    safety_assured do
      # org_contacts.status_id -> org_contact_statuses with ON DELETE SET NULL
      replace_fk_with_nullify(:org_contacts, :org_contact_statuses, :status_id)
