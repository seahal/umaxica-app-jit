...
class CreateCustomerAuthorizationCodes < ActiveRecord::Migration[8.2]
  def change
    create_table(:customer_authorization_codes) do |t|
    ...
    add_index(:customer_authorization_codes, :code, unique: true)
    add_index(:customer_authorization_codes, :varnishable_at)
  end
end
