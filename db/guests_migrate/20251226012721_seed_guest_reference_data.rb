...
class SeedGuestReferenceData < ActiveRecord::Migration[8.2]
  def up
    # ComContactCategory
    seed_with_attributes(:com_contact_categories, [
    ...
    # AppContactCategory
    seed_with_attributes(:app_contact_categories, [
    ...
    # OrgContactCategory
    seed_with_attributes(:org_contact_categories, [
      { id: 'COULD_NOT_SIGN_IN', description: 'user had a problem to sign/log in' },
      { id: 'NULL_CONTACT_STATUS', description: 'NULL' },
    ...
    # ComContactStatus
    seed_with_attributes(:com_contact_statuses, [
