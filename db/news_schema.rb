...
ActiveRecord::Schema[8.2].define(version: 2026_01_14_115822) do
  ...
  create_table "app_timeline_category_masters", id: { type: :string, limit: 255 }, force: :cascade do |t|
    ...
    t.check_constraint "id::text ~ '^[A-Z0-9_]+$'::text", name: "app_timeline_category_masters_id_format_check"
  end
  ...
  create_table "app_timeline_statuses", id: { type: :string, limit: 255 }, force: :cascade do |t|
    ...
    t.check_constraint "id::text ~ '^[A-Z0-9_]+$'::text", name: "app_timeline_statuses_id_format_check"
  end
  ...
  create_table "app_timeline_tag_masters", id: { type: :string, limit: 255 }, force: :cascade do |t|
    ...
    t.check_constraint "id::text ~ '^[A-Z0-9_]+$'::text", name: "app_timeline_tag_masters_id_format_check"
  end
  ...
  create_table "com_timeline_category_masters", id: { type: :string, limit: 255 }, force: :cascade do |t|
    ...
    t.check_constraint "id::text ~ '^[A-Z0-9_]+$'::text", name: "com_timeline_category_masters_id_format_check"
  end
  ...
  create_table "com_timeline_statuses", id: { type: :string, limit: 255 }, force: :cascade do |t|
    ...
    t.check_constraint "id::text ~ '^[A-Z0-9_]+$'::text", name: "com_timeline_statuses_id_format_check"
  end
  ...
  create_table "com_timeline_tag_masters", id: { type: :string, limit: 255 }, force: :cascade do |t|
    ...
    t.check_constraint "id::text ~ '^[A-Z0-9_]+$'::text", name: "com_timeline_tag_masters_id_format_check"
  end
  ...
  create_table "org_timeline_category_masters", id: { type: :string, limit: 255 }, force: :cascade do |t|
    ...
    t.check_constraint "id::text ~ '^[A-Z0-9_]+$'::text", name: "org_timeline_category_masters_id_format_check"
  end
  ...
  create_table "org_timeline_statuses", id: { type: :string, limit: 255 }, force: :cascade do |t|
    ...
    t.check_constraint "id::text ~ '^[A-Z0-9_]+$'::text", name: "org_timeline_statuses_id_format_check"
  end
  ...
  create_table "org_timeline_tag_masters", id: { type: :string, limit: 255 }, force: :cascade do |t|
    ...
    t.check_constraint "id::text ~ '^[A-Z0-9_]+$'::text", name: "org_timeline_tag_masters_id_format_check"
  end
