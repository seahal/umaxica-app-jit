...
ActiveRecord::Schema[8.2].define(version: 2026_01_14_115821) do
  ...
  create_table "app_document_category_masters", id: { type: :string, limit: 255 }, force: :cascade do |t|
    ...
    t.check_constraint "id::text ~ '^[A-Z0-9_]+$'::text", name: "app_document_category_masters_id_format_check"
  end
  ...
  create_table "app_document_statuses", id: { type: :string, limit: 255, default: "NEYO" }, force: :cascade do |t|
    ...
    t.check_constraint "id::text ~ '^[A-Z0-9_]+$'::text", name: "app_document_statuses_id_format_check"
  end
  ...
  create_table "app_document_tag_masters", id: { type: :string, limit: 255 }, force: :cascade do |t|
    ...
    t.check_constraint "id::text ~ '^[A-Z0-9_]+$'::text", name: "app_document_tag_masters_id_format_check"
  end
  ...
  create_table "app_documents", id: :uuid, default: -> { "uuidv7()" }, force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.index ["latest_revision_id"], name: "index_app_documents_on_latest_revision_id"
    t.index ["latest_version_id"], name: "index_app_documents_on_latest_version_id"
  ...
  create_table "com_document_category_masters", id: { type: :string, limit: 255 }, force: :cascade do |t|
    ...
    t.check_constraint "id::text ~ '^[A-Z0-9_]+$'::text", name: "com_document_category_masters_id_format_check"
  end
  ...
  create_table "com_document_statuses", id: { type: :string, limit: 255 }, force: :cascade do |t|
    ...
    t.check_constraint "id::text ~ '^[A-Z0-9_]+$'::text", name: "com_document_statuses_id_format_check"
  end
  ...
  create_table "com_document_tag_masters", id: { type: :string, limit: 255 }, force: :cascade do |t|
    ...
    t.check_constraint "id::text ~ '^[A-Z0-9_]+$'::text", name: "com_document_tag_masters_id_format_check"
  end
  ...
  create_table "org_document_category_masters", id: { type: :string, limit: 255 }, force: :cascade do |t|
    ...
    t.check_constraint "id::text ~ '^[A-Z0-9_]+$'::text", name: "org_document_category_masters_id_format_check"
  end
  ...
  create_table "org_document_statuses", id: { type: :string, limit: 255 }, force: :cascade do |t|
    ...
    t.check_constraint "id::text ~ '^[A-Z0-9_]+$'::text", name: "org_document_statuses_id_format_check"
  end
  ...
  create_table "org_document_tag_masters", id: { type: :string, limit: 255 }, force: :cascade do |t|
    ...
    t.check_constraint "id::text ~ '^[A-Z0-9_]+$'::text", name: "org_document_tag_masters_id_format_check"
  end
  ...
  add_foreign_key "app_documents", "app_document_revisions", column: "latest_revision_id"
  add_foreign_key "app_documents", "app_document_statuses", column: "status_id", validate: false
  add_foreign_key "app_documents", "app_document_versions", column: "latest_version_id"
