...
ActiveRecord::Schema[8.2].define(version: 2026_03_29_153500) do
  ...
  add_foreign_key "app_documents", "app_document_revisions", column: "latest_revision_id", on_delete: :nullify
  add_foreign_key "app_documents", "app_document_statuses", column: "status_id"
  add_foreign_key "app_documents", "app_document_versions", column: "latest_version_id", on_delete: :nullify
  ...
  add_foreign_key "com_documents", "com_document_revisions", column: "latest_revision_id", on_delete: :nullify
  add_foreign_key "com_documents", "com_document_statuses", column: "status_id"
  add_foreign_key "com_documents", "com_document_versions", column: "latest_version_id", on_delete: :nullify
  ...
  add_foreign_key "org_documents", "org_document_revisions", column: "latest_revision_id", on_delete: :nullify
  add_foreign_key "org_documents", "org_document_statuses", column: "status_id"
  add_foreign_key "org_documents", "org_document_versions", column: "latest_version_id", on_delete: :nullify
end
