...
class AddUserIdentityGoogleAuthStatusToUserGoogleAuths < ActiveRecord::Migration[8.2]
  ...
  def change
    ...
    unless index_exists?(:user_google_auths, :user_identity_google_auth_status_id)
      add_index(:user_google_auths, :user_identity_google_auth_status_id, algorithm: :concurrently)
    end
    ...
    add_foreign_key(
      ...
      column: :user_identity_google_auth_status_id, primary_key: :id, validate: false,
    )
