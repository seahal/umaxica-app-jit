...
class AddLatestVersionAndRevisionToDocuments < ActiveRecord::Migration[7.1]
  ...
  def change
    ...
    add_foreign_key(
      :app_documents, :app_document_versions,
      column: :latest_version_id,
      on_delete: :nullify,
      validate: false,
    )
    add_foreign_key(
      :app_documents, :app_document_revisions,
    ...
    add_index(
      :app_documents, :latest_version_id,
      name: "index_app_documents_on_latest_version_id",
      unique: true,
      algorithm: :concurrently,
    )
    add_index(
      :app_documents, :latest_revision_id,
    ...
    add_foreign_key(
      :com_documents, :com_document_versions,
      column: :latest_version_id,
      on_delete: :nullify,
      validate: false,
    )
    add_foreign_key(
      :com_documents, :com_document_revisions,
      column: :latest_revision_id,
      on_delete: :nullify,
      validate: false,
    )
    ...
    add_index(
      :com_documents, :latest_version_id,
      name: "index_com_documents_on_latest_version_id",
      unique: true,
      algorithm: :concurrently,
    )
    add_index(
      :com_documents, :latest_revision_id,
    ...
    add_foreign_key(
      :org_documents, :org_document_versions,
      column: :latest_version_id,
      on_delete: :nullify,
      validate: false,
    )
    add_foreign_key(
      :org_documents, :org_document_revisions,
      column: :latest_revision_id,
      on_delete: :nullify,
      validate: false,
    )
    ...
    add_index(
      :org_documents, :latest_version_id,
      name: "index_org_documents_on_latest_version_id",
      unique: true,
      algorithm: :concurrently,
    )
    add_index(
      :org_documents, :latest_revision_id,
