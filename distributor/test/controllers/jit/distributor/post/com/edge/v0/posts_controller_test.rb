          ...
          module V0
            class PostsControllerTest < ActionDispatch::IntegrationTest
              ...
              test "should show 404 for non-existent permalink" do
                get distributor.post_com_edge_v0_post_url(id: "nonexistent_permalink_xyz")
              ...
              test "should not show expired documents" do
                ...
                get distributor.post_com_edge_v0_post_url(id: expired_doc.permalink)
              ...
              test "should not show unpublished documents" do
                ...
                get distributor.post_com_edge_v0_post_url(id: future_doc.permalink)
              ...
              test "should show all documents list" do
                get distributor.post_com_edge_v0_posts_url

                assert_response :success
              end

              test "should search documents by query" do
                get distributor.post_com_edge_v0_posts_url(q: "test")
