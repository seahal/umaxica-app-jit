...
class Api::App::ApplicationHelperTest < ActionView::TestCase
  setup do
    extend Api::App::ApplicationHelper
  end
  ...
  test "to_localetime should handle edge cases with empty strings" do
    test_time = Time.parse("2023-12-25 15:30:45 UTC")
    result = to_localetime(test_time, "")
