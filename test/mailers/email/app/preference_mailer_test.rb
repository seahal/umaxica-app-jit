...
module Email::App
  class PreferenceMailerTest < ActionMailer::TestCase
    ...
    test "update_request sends preference request email with expected subject and recipient" do
      mail = build_mail(address: "user@example.com", edit_url: "https://example.com/preferences/edit")

      assert_equal [ "user@example.com" ], mail.to
      assert_equal I18n.t("email.app.preference_mailer.update_request.subject"), mail.subject
    ...
    test "update_request builds a multipart email" do
      mail = build_mail(address: "user@example.net", edit_url: "https://example.net/update_preferences")
    ...
    test "text part contains localized intro and edit link" do
      ...
      mail = build_mail(address: "user@example.org", edit_url: edit_url)

      assert_not_nil mail.text_part
      text_body = mail.text_part.body.decoded

      assert_match I18n.t("email.app.preference_mailer.update_request.intro"), text_body
    ...
    test "html part contains localized CTA and edit link" do
      ...
      assert_match I18n.t("email.app.preference_mailer.update_request.cta"), html_body
