...
class ApexPreferenceRegionsFlowTest < ActionDispatch::IntegrationTest
  ...
  DOMAINS = [
    { name: "app",
      edit: :edit_apex_app_preference_region_url,
      update: :apex_app_preference_region_url,
      scope: "apex.app.preferences", },
    { name: "com",
      edit: :edit_apex_com_preference_region_url,
      update: :apex_com_preference_region_url,
      scope: "apex.com.preferences", },
    { name: "org",
      edit: :edit_apex_org_preference_region_url,
      update: :apex_org_preference_region_url,
