...
class PreferenceManagementFlowTest < ActionDispatch::IntegrationTest
  ...
  test "preference language update persists across requests" do
    ...
    patch sign_app_preference_region_language_url(ri: "jp"),
          params: { preference_language: { option_id: "EN" } }

    assert_redirected_to edit_sign_app_preference_region_language_url(ri: "jp")
    follow_redirect!
  ...
  test "preference reset requires confirmation" do
    ...
    get edit_sign_app_preference_reset_url(ri: "jp")

    assert_response :success

    delete sign_app_preference_reset_url(ri: "jp"), params: { confirm_reset: "0" }

    assert_response :unprocessable_content

    delete sign_app_preference_reset_url(ri: "jp"), params: { confirm_reset: "1" }

    assert_redirected_to edit_sign_app_preference_reset_url(ri: "jp")
  end
