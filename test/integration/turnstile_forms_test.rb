...
class TurnstileFormsTest < ActionDispatch::IntegrationTest
  def setup
    ...
    @turnstile_form_paths = [
      { name: "Sign::App registration emails", env_key: "ID_SERVICE_URL", path: "/up/emails/new" },
      { name: "Sign::App authentication email", env_key: "ID_SERVICE_URL", path: "/in/email/new" },
