...
class SocialAuthLoginTest < ActionDispatch::IntegrationTest
  ...
  test "Google login with existing identity does not create new user" do
    ...
    existing_user = User.create!(status_id: UserStatus::ACTIVE, public_id: "ex_#{SecureRandom.hex(4)}")
  ...
  test "Apple login with existing identity does not create new user" do
    ...
    existing_user = User.create!(status_id: UserStatus::ACTIVE, public_id: "ex_ap_#{SecureRandom.hex(4)}")
  ...
  test "login updates last_authenticated_at on existing identity" do
    ...
    existing_user = User.create!(status_id: UserStatus::ACTIVE, public_id: "at_#{SecureRandom.hex(4)}")
