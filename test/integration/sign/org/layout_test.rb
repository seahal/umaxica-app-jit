...
class Sign::Org::LayoutTest < ActionDispatch::IntegrationTest
  ...
  #   get new_sign_org_registration_url, headers: default_headers

  #   assert_response :success

  #   assert_select "header" do
  #     assert_select "a[href*=?]", "/registration/new", text: I18n.t("sign.org.layout.nav.sign_up")
  #     assert_select "a[href*=?]", "/authentication/new", text: I18n.t("sign.org.layout.nav.log_in")
  ...
  #   # new_sign_org_registration_url might redirect if logged in?
  #   # Let's check Sign::Org::RegistrationsController.
  #   # But for now let's try accessing setting page since we added it.
  #   get sign_org_configuration_url, headers: login_headers(staff)
