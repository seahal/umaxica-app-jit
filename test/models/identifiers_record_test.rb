...
class PrincipalRecordTest < ActiveSupport::TestCase
  ...
  test "should connect to identifier database" do
    ...
    assert_respond_to PrincipalRecord, :connection_db_config
  end

  test "should have correct database configuration" do
    config = PrincipalRecord.connection_db_config

    assert_not_nil config
  end

  test "should connect to identifier database for writing and reading" do
    assert_respond_to PrincipalRecord, :connection
    assert_respond_to PrincipalRecord, :connected?
  end
  ...
  test "should have proper database connection specification" do
    writing_config = PrincipalRecord.connection_specification_name
  ...
  test "should support encryption functionality" do
    ...
    assert_respond_to PrincipalRecord, :encrypts
  end
