...
class AppDocumentTagMasterTest < ActiveSupport::TestCase
  ...
  test "validates id presence and uniqueness" do
    ...
    existing = AppDocumentTagMaster.first || AppDocumentTagMaster.create!(id: "EXISTING")
    duplicate = AppDocumentTagMaster.new(id: existing.id.downcase)
    assert_not duplicate.valid?
    assert_not_empty duplicate.errors[:id]
  end

  test "upcases id before validation" do
    master = AppDocumentTagMaster.new(id: "new_category")
    master.valid?
    assert_equal "NEW_CATEGORY", master.id
  end

  test "validates id format" do
    master = AppDocumentTagMaster.new(id: "INVALID-ID!")
    assert_not master.valid?
    assert_not_empty master.errors[:id]
  end

  test "root? returns true when parent_id is NEYO" do
    master = AppDocumentTagMaster.new(id: "ROOT", parent_id: "NEYO")
  ...
  test "parent and children associations" do
    parent = AppDocumentTagMaster.create!(id: "PARENT_CAT")
    child = AppDocumentTagMaster.create!(id: "CHILD_CAT", parent: parent)
  ...
  test "name returns translated string" do
    master = AppDocumentTagMaster.new(id: "TEST_CAT")
  ...
  test "validates length of id" do
    record = AppDocumentTagMaster.new(id: "A" * 256)
