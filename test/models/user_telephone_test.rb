...
#  user_telephone_status_id :string(255)      default("UNVERIFIED"), not null
#
# Indexes
#
#  idx_on_user_telephone_status_id_a15207191e  (user_telephone_status_id)
...
class UserTelephoneTest < ActiveSupport::TestCase
  ...
  test "enforce_user_telephone_limit validation on create" do
    ...
    UserTelephone::MAX_TELEPHONES_PER_USER.times do |i|
      UserTelephone.create!(@valid_attributes.merge(number: "+155512310#{i}"))
    end
