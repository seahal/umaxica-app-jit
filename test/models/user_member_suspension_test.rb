...
class UserMemberSuspensionTest < ActiveSupport::TestCase
  fixtures :user_member_suspensions, :users, :user_statuses, :members, :member_statuses, :divisions,
           :division_statuses, :organizations, :organization_statuses

  test "fixture is valid" do
    assert_predicate UserMemberSuspension.first, :valid?
  end
end
