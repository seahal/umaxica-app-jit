...
class UserHmacBasedOneTimePasswordTest < ActiveSupport::TestCase
  test "inherits from IdentitiesRecord" do
    assert_operator UserHmacBasedOneTimePassword, :<, IdentitiesRecord
  end

  test "belongs to user" do
    association = UserHmacBasedOneTimePassword.reflect_on_association(:user)
  ...
  test "belongs to hmac_based_one_time_password" do
    association = UserHmacBasedOneTimePassword.reflect_on_association(:hmac_based_one_time_password)
  ...
  #   record = user_hmac_based_one_time_passwords(:one)
  ...
  test "allows assignment of associations before persistence" do
    ...
    record = UserHmacBasedOneTimePassword.new(user:, hmac_based_one_time_password: hmac)
