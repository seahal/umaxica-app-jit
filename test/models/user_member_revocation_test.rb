...
class UserMemberRevocationTest < ActiveSupport::TestCase
  fixtures :user_member_revocations, :users, :user_statuses, :members, :member_statuses, :divisions,
           :division_statuses, :organizations, :organization_statuses

  test "fixture is valid" do
    assert_predicate UserMemberRevocation.first, :valid?
  end
end
