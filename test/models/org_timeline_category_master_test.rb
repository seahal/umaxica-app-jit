...
class OrgTimelineCategoryMasterTest < ActiveSupport::TestCase
  test "validates id presence and uniqueness" do
    master = OrgTimelineCategoryMaster.new(id: nil)
    assert_not master.valid?
    assert_not_empty master.errors[:id]

    existing = OrgTimelineCategoryMaster.first || OrgTimelineCategoryMaster.create!(id: "EXISTING")
    duplicate = OrgTimelineCategoryMaster.new(id: existing.id.downcase)
    assert_not duplicate.valid?
    assert_not_empty duplicate.errors[:id]
  end

  test "upcases id before validation" do
    master = OrgTimelineCategoryMaster.new(id: "new_category")
    master.valid?
    assert_equal "NEW_CATEGORY", master.id
  end

  test "validates id format" do
    master = OrgTimelineCategoryMaster.new(id: "INVALID-ID!")
    assert_not master.valid?
    assert_not_empty master.errors[:id]
  end

  test "root? returns true when parent_id is NEYO" do
    master = OrgTimelineCategoryMaster.new(id: "ROOT", parent_id: "NEYO")
  ...
  test "parent and children associations" do
    parent = OrgTimelineCategoryMaster.create!(id: "PARENT_CAT")
    child = OrgTimelineCategoryMaster.create!(id: "CHILD_CAT", parent: parent)
  ...
  test "name returns translated string" do
    master = OrgTimelineCategoryMaster.new(id: "TEST_CAT")
  ...
  test "validates length of id" do
    record = OrgTimelineCategoryMaster.new(id: "A" * 256)
