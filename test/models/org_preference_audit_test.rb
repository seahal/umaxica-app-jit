...
class OrgPreferenceAuditTest < ActiveSupport::TestCase
  setup do
    @audit = org_preference_audits(:one)
  ...
  test "belongs to org_preference_audit_level" do
    assert_equal org_preference_audit_levels(:info), @audit.org_preference_audit_level
  end

  test "belongs to org_preference_audit_event" do
    assert_equal org_preference_audit_events(:create_new_preference_token), @audit.org_preference_audit_event
  end
