...
class OrgDocumentAuditLevelTest < ActiveSupport::TestCase
  test "restrict_with_error on destroy when audits exist" do
    level = OrgDocumentAuditLevel.find(OrgDocumentAuditLevel::NEYO)
    ...
    OrgDocumentAudit.create!(
      org_document: doc,
      org_document_audit_event: OrgDocumentAuditEvent.find(OrgDocumentAuditEvent::CREATED),
  ...
  test "can destroy when no audits exist" do
    level = OrgDocumentAuditLevel.create!(id: 2)
  ...
  test "accepts integer ids" do
    record = OrgDocumentAuditLevel.new(id: 3)
