...
class StaffIdentityAuditEventTest < ActiveSupport::TestCase
  def setup
    @audit_event = StaffIdentityAuditEvent.new(id: "TEST_EVENT")
  end

  # ID default value tests
  test "default id value is NONE" do
    event = StaffIdentityAuditEvent.new
  ...
  test "id must be unique" do
    StaffIdentityAuditEvent.create!(id: "UNIQUE_EVENT")
    duplicate = StaffIdentityAuditEvent.new(id: "UNIQUE_EVENT")
  ...
  test "id exceeding 255 characters should raise error when saving" do
    ...
    assert_raises(ActiveRecord::StatementInvalid) do
      StaffIdentityAuditEvent.create!(id: long_id)
    end
  end
end
