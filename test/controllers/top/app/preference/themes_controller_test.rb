    ...
    module Preference
      class ThemesControllerTest < ActionDispatch::IntegrationTest
        ...
        test "renders theme edit page with system selected by default 2" do
          get edit_top_app_preference_theme_url

          assert_response :success

          assert_select "h1", text: I18n.t("top.app.preference.theme.edit.title")
          assert_select "p.theme-description", text: I18n.t("top.app.preference.theme.edit.description")

          assert_select "form" do
            assert_select "legend", text: I18n.t("top.app.preference.theme.edit.legend")
            ...
            assert_select "label[for='theme_light_app']", text: I18n.t("top.app.preference.theme.edit.options.light")
            assert_select "label[for='theme_dark_app']", text: I18n.t("top.app.preference.theme.edit.options.dark")
            assert_select "label[for='theme_system_app']", text: I18n.t("top.app.preference.theme.edit.options.system")
            assert_select ".hint", text: I18n.t("top.app.preference.theme.edit.hints.light")
            assert_select ".hint", text: I18n.t("top.app.preference.theme.edit.hints.dark")
            assert_select ".hint", text: I18n.t("top.app.preference.theme.edit.hints.system")
        ...
        test "re-renders edit on invalid theme selection" do
          patch top_app_preference_theme_url, params: { theme: "li", lx: "ja", ri: "jp", tz: "jst" }
