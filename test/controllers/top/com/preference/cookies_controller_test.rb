...
class Top::Com::Preference::CookiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should get edit" do
    ...
    get edit_top_com_preference_cookie_url

    assert_response :success
    assert_select "h1", I18n.t("top.com.preference.cookie.edit.h1")
    expected_action = top_com_preference_cookie_url(ri: "jp", tz: "jst", lx: "ja")
    assert_select "form[action=?]", expected_action do
      ...
      assert_select "label", I18n.t("top.com.preference.cookie.edit.accept_necessary_cookies")
      assert_select "label", I18n.t("top.com.preference.cookie.edit.accept_targeting_cookies")
      assert_select "label", I18n.t("top.com.preference.cookie.edit.accept_functional_cookies")
      assert_select "label", I18n.t("top.com.preference.cookie.edit.accept_performance_cookies")
  ...
  test "submitting the form toggles the checkboxes via persisted preferences" do
    ...
    patch top_com_preference_cookie_url,
          params: {
