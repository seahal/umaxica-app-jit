...
class Top::Org::Preference::CookiesControllerTest < ActionDispatch::IntegrationTest
  # rubocop:disable Minitest/MultipleAssertions
  test "should get edit" do
    original_forgery_setting = ActionController::Base.allow_forgery_protection
    ActionController::Base.allow_forgery_protection = true

    get edit_top_org_preference_cookie_url
    ...
    assert_select "form" do
      ...
      assert_select "label", I18n.t("top.org.preference.cookie.edit.accept_necessary_cookies")
      assert_select "label", I18n.t("top.org.preference.cookie.edit.accept_targeting_cookies")
      assert_select "label", I18n.t("top.org.preference.cookie.edit.accept_functional_cookies")
      assert_select "label", I18n.t("top.org.preference.cookie.edit.accept_performance_cookies")
      assert_select "input[type='submit']", count: 1
    end
    assert_select "a[href^='#{top_org_preference_path}']", text: I18n.t("top.org.preferences.back_to_settings"), count: 1
  ensure
  ...
  test "submitting the form toggles the checkboxes via persisted preferences" do
    ...
    patch top_org_preference_cookie_url,
          params: {
