    ...
    module Preference
      class ThemesControllerTest < ActionDispatch::IntegrationTest
        ...
        test "renders theme edit page with system selected by default" do
          get edit_top_org_preference_theme_url

          assert_response :success

          assert_select "h1", text: I18n.t("top.org.preference.theme.edit.title")
          assert_select "p.theme-description", text: I18n.t("top.org.preference.theme.edit.description")

          assert_select "form" do
            assert_select "legend", text: I18n.t("top.org.preference.theme.edit.legend")
            ...
            assert_select "label[for='theme_light_org']", text: I18n.t("top.org.preference.theme.edit.options.light")
            assert_select "label[for='theme_dark_org']", text: I18n.t("top.org.preference.theme.edit.options.dark")
            assert_select "label[for='theme_system_org']", text: I18n.t("top.org.preference.theme.edit.options.system")
            assert_select ".hint", text: I18n.t("top.org.preference.theme.edit.hints.light")
            assert_select ".hint", text: I18n.t("top.org.preference.theme.edit.hints.dark")
            assert_select ".hint", text: I18n.t("top.org.preference.theme.edit.hints.system")
