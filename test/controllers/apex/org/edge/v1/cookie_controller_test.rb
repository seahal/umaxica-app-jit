...
class Apex::Org::Edge::V1::CookieControllerTest < ActionDispatch::IntegrationTest
  setup do
    host! ENV.fetch("APEX_STAFF_URL", "org.localhost")
  end

  test "GET show returns 200 with boolean show_banner" do
    get apex_org_edge_v1_cookie_path, as: :json
  ...
  def json_headers(with_csrf:)
    headers = { "Host" => ENV.fetch("APEX_STAFF_URL", "org.localhost"), "Accept" => "application/json" }
    if with_csrf
