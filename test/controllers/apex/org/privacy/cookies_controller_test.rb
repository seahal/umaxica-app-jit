...
class Apex::Org::Privacy::CookiesControllerTest < ActionDispatch::IntegrationTest
  # rubocop:disable Minitest/MultipleAssertions
  test "should get edit" do
    original_forgery_setting = ActionController::Base.allow_forgery_protection
    ActionController::Base.allow_forgery_protection = true

    get edit_apex_org_privacy_cookie_url
    ...
    assert_select "a[href^='#{apex_org_preference_path}']", text: I18n.t("apex.org.preferences.back_to_settings"), count: 1
  ensure
  ...
  test "submitting the form toggles the checkboxes via persisted preferences" do
    ...
    patch apex_org_privacy_cookie_url,
          params: {
