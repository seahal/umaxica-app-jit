...
class Apex::Com::Edge::V1::CookieControllerTest < ActionDispatch::IntegrationTest
  setup do
    host! ENV.fetch("APEX_CORPORATE_URL", "com.localhost")
  end

  test "GET show returns 200 with boolean show_banner" do
    get apex_com_edge_v1_cookie_path, as: :json
