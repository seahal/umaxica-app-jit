...
class Apex::Com::Privacy::CookiesControllerTest < ActionDispatch::IntegrationTest
  # rubocop:disable Minitest/MultipleAssertions
  test "should get edit" do
    original_forgery_setting = ActionController::Base.allow_forgery_protection
    ActionController::Base.allow_forgery_protection = true

    get edit_apex_com_privacy_cookie_url

    assert_response :success
    assert_select "h1", I18n.t("apex.com.preference.cookie.edit.h1")
    expected_action = apex_com_privacy_cookie_url(ri: "jp", tz: "jst", lx: "ja")
    ...
    assert_select "a[href^='#{apex_com_preference_path}']", text: I18n.t("apex.com.preferences.back_to_settings"), count: 1
  ensure
  ...
  test "submitting the form toggles the checkboxes via persisted preferences" do
    ...
    patch apex_com_privacy_cookie_url,
          params: {
