    ...
    module Preference
      class ThemesControllerTest < ActionDispatch::IntegrationTest
        ...
        test "updates theme preference and persists to cookies" do
          ...
          assert_select "a[href^='#{apex_com_preference_path}']", minimum: 1
        end
        # rubocop:enable Minitest/MultipleAssertions

        # rubocop:disable Minitest/MultipleAssertions
        test "re-renders edit on invalid theme selection" do
          patch apex_com_preference_theme_url, params: { theme: "li", lx: "ja", ri: "jp", tz: "jst" }
          ...
          patch apex_com_preference_theme_url, params: { theme: "neon", lx: "ja", ri: "jp", tz: "jst" }
