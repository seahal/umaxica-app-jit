...
class Apex::Com::PreferencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "footer has navigation links" do
    ...
    assert_select "footer" do
      assert_select "a[href=?]", "http://com.localhost:3000/",
                    text: I18n.t("apex.com.preferences.footer.home")
  ...
  test "shows 'うえへ' link back to preference anchor" do
    ...
    assert_select "p.mt-10" do
      assert_select "a[href=?]", apex_com_root_path(ct: "dr", lx: "en", ri: "us", tz: "jst"),
                    text: /\A↑\s*#{Regexp.escape(I18n.t("apex.com.preferences.up_link"))}\z/
    end
  end
end
