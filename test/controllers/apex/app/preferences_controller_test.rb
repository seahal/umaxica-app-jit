...
class Apex::App::PreferencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should display i18n content in preferences page" do
    ...
    assert_select "a[href*=?]", edit_apex_app_preference_cookie_path,
                  text: I18n.t("apex.app.preferences.cookie_settings")
  end
  ...
  test "renders localized up link on preferences page" do
    ...
    assert_select "p.mt-10" do
      assert_select "a[href=?]", apex_app_root_path(ct: "dr", lx: "en", ri: "us", tz: "jst"),
                    text: /\A↑\s*#{Regexp.escape(I18n.t("apex.app.preferences.up_link"))}\z/
    end
  end
end
