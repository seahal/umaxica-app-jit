    ...
    module Preference
      class ThemesControllerTest < ActionDispatch::IntegrationTest
        ...
        test "renders theme edit page with system selected by default 2" do
          ...
          assert_select "p.theme-description", text: I18n.t("apex.app.preference.theme.edit.description"), count: 1
          ...
          assert_select "form" do
            ...
            assert_select "p", text: I18n.t("apex.app.preference.theme.edit.hints.light")
            assert_select "p", text: I18n.t("apex.app.preference.theme.edit.hints.dark")
            assert_select "p", text: I18n.t("apex.app.preference.theme.edit.hints.system")
        ...
        test "updates theme preference and persists to cookies" do
          ...
          assert_select "a[href^='#{apex_app_preference_path}']", minimum: 1
        end
        # rubocop:enable Minitest/MultipleAssertions
