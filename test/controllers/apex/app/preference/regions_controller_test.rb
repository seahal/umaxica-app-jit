...
class Apex::App::Preference::RegionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "PATCH with region updates session and redirects with success notice" do
    patch apex_app_preference_region_url, params: { region: "US", country: "US" }

    assert_redirected_to edit_apex_app_preference_region_url(ri: "us")
  ...
  test "PATCH should persist region preference and redirect with correct parameters" do
    ...
    assert_redirected_to edit_apex_app_preference_region_url(ri: "jp")
