    ...
    module Preference
      class RegionsControllerTest < ActionDispatch::IntegrationTest
        setup do
          ...
          @preference_region = AppPreferenceRegion.find_by(preference_id: @preference.id) ||
            AppPreferenceRegion.create!(preference_id: @preference.id, option_id: "US")
        ...
        test "should get edit" do
          ...
          get edit_apex_app_preference_region_url, headers: { "Cookie" => "#{cookie_name}=#{@token}" }
        ...
        test "should update region preference and create audit log" do
          ...
          patch apex_app_preference_region_url,
                params: {
                  preference_region: {
                    option_id: "JP",
                  },
