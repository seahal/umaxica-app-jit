    ...
    module Preference
      class LanguagesControllerTest < ActionDispatch::IntegrationTest
        setup do
          ...
          @preference_language = AppPreferenceLanguage.find_by(preference_id: @preference.id) ||
            AppPreferenceLanguage.create!(preference_id: @preference.id, option_id: "EN")
        ...
        test "should get edit" do
          ...
          get edit_apex_app_preference_language_url, headers: { "Cookie" => "#{cookie_name}=#{@token}" }
