...
class Apex::App::Privacy::CookiesControllerTest < ActionDispatch::IntegrationTest
  # rubocop:disable Minitest/MultipleAssertions
  test "should get edit" do
    original_forgery_setting = ActionController::Base.allow_forgery_protection
    ActionController::Base.allow_forgery_protection = true

    get edit_apex_app_privacy_cookie_url

    assert_response :success
    assert_select "h1", I18n.t("apex.app.preference.cookie.edit.h1")
    expected_action = apex_app_privacy_cookie_url(ri: "jp", tz: "jst", lx: "ja")
    ...
    assert_select "a[href^='#{apex_app_preference_path}']", text: I18n.t("apex.app.preferences.back_to_settings")
  ensure
  ...
  test "submitting the form toggles the checkboxes via persisted preferences" do
    ...
    patch apex_app_privacy_cookie_url,
          params: {
