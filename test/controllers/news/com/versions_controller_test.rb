...
class News::Com::VersionsControllerTest < ActionDispatch::IntegrationTest
  setup do
  ...
  test "should get new" do
    get new_news_com_post_version_url(post_id: 1)
    assert_response :success
  end

  test "should create version" do
    post news_com_post_versions_url(post_id: 1), params: { version: { body: "foo" } }
    assert_redirected_to news_com_post_versions_url(post_id: 1)
  end

  test "should get edit" do
    get edit_news_com_post_version_url(post_id: 1, id: 1)
    assert_response :success
  end

  test "should update version" do
    patch news_com_post_version_url(post_id: 1, id: 1), params: { version: { body: "bar" } }
    assert_redirected_to news_com_post_version_url(post_id: 1, id: 1)
  end

  test "should destroy version" do
    delete news_com_post_version_url(post_id: 1, id: 1)
    assert_redirected_to news_com_post_versions_url(post_id: 1)
  end
end
