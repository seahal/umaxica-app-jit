    ...
    module V0
      class TaxonomiesControllerTest < ActionDispatch::IntegrationTest
        ...
        TAXONOMY_SPECS = [
          {
            name: "news com tags",
            url_helper: :news_com_edge_v0_tags_url,
          ...
          },
          {
            ...
            url_helper: :news_com_edge_v0_categories_url,
          ...
          {
            name: "news app tags",
            url_helper: :news_app_edge_v0_tags_url,
          ...
          },
          {
            ...
            url_helper: :news_app_edge_v0_categories_url,
          ...
          {
            name: "news org tags",
            url_helper: :news_org_edge_v0_tags_url,
          ...
          },
          {
            ...
            url_helper: :news_org_edge_v0_categories_url,
