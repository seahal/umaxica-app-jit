...
class Root::App::Preference::RegionsControllerAdditionalTest < ActionDispatch::IntegrationTest
  ...
  test "PATCH with country only updates session country and redirects" do
    patch root_app_preference_region_url, params: { country: "JP" }
  ...
  test "PATCH with UTC timezone stores UTC in session" do
    ...
    assert_redirected_to edit_root_app_preference_region_url(lx: "ja", ri: "jp", tz: "etc/utc")
  ...
  test "PATCH with invalid language sets flash alert and renders edit" do
    patch root_app_preference_region_url, params: { language: "fr" }

    assert_response :unprocessable_content
    assert_equal I18n.t("root.app.preferences.languages.unsupported"), flash[:alert]
  end

  # Test flash alert on timezone error
  test "PATCH with invalid timezone sets flash alert and renders edit" do
    patch root_app_preference_region_url, params: { timezone: "America/New_York" }

    assert_response :unprocessable_content
    assert_equal I18n.t("root.app.preferences.timezones.invalid"), flash[:alert]
  end
  ...
  test "PATCH with valid params persists preferences to signed cookie" do
    patch root_app_preference_region_url, params: { region: "US", language: "EN", timezone: "Etc/UTC" }

    cookie_value = signed_cookie(:root_app_preferences)
  ...
  test "GET edit with session values sets instance variables from session" do
    ...
    patch root_app_preference_region_url, params: { region: "JP", country: "JP", language: "JA", timezone: "Asia/Tokyo" }
  ...
  test "PATCH with matching region and country updates both" do
    patch root_app_preference_region_url, params: { region: "JP", country: "JP" }
  ...
  test "PATCH with EN language and US region creates english cookie" do
    patch root_app_preference_region_url, params: { language: "EN", region: "US" }
  ...
  test "PATCH with JA language and JP region creates japanese cookie" do
    patch root_app_preference_region_url, params: { language: "JA", region: "JP" }
