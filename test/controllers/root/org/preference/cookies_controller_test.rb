...
class Root::Org::Preference::CookiesControllerTest < ActionDispatch::IntegrationTest
  # rubocop:disable Minitest/MultipleAssertions
  test "should get edit" do
    original_forgery_setting = ActionController::Base.allow_forgery_protection
    ActionController::Base.allow_forgery_protection = true
    get edit_root_org_preference_cookie_url
    assert_select "form" do
      ...
      assert_select "label", I18n.t("root.org.preference.cookie.edit.accept_functional_cookies")
      assert_select "label", I18n.t("root.org.preference.cookie.edit.accept_performance_cookies")
      assert_select "label", I18n.t("root.org.preference.cookie.edit.accept_targeting_cookies")
      assert_select "input[type=?]", "submit"
    end
    assert_select "a.btn.btn-secondary[href^='#{root_org_preference_path}']", text: I18n.t("root.org.preferences.back_to_settings"), count: 1
  ...
  test "checking cookie policy" do
    ...
    assert_response :success
    assert_select "h1", I18n.t("root.org.preference.cookie.edit.h1")
    assert_select "div#hello-world-component", count: 0
    expected_action = root_org_preference_cookie_url(ri: "jp", tz: "jst", lx: "ja")
    assert_select "form[action=?]", expected_action do
      ...
      assert_select "label", I18n.t("root.org.preference.cookie.edit.accept_performance_cookies")
      assert_select "label", I18n.t("root.org.preference.cookie.edit.accept_targeting_cookies")
      assert_select "label", I18n.t("root.org.preference.cookie.edit.accept_necessary_cookies")
      assert_select "label", I18n.t("root.org.preference.cookie.edit.accept_functional_cookies")
      assert_select "label", I18n.t("root.org.preference.cookie.edit.accept_performance_cookies")
      assert_select "label", I18n.t("root.org.preference.cookie.edit.accept_targeting_cookies")
      assert_select "input[type=?]", "submit"
  ...
  test "submitting the form persists admin cookie preferences" do
    ...
    patch root_org_preference_cookie_url,
          params: {
