...
class Root::Org::RootsControllerTest < ActionDispatch::IntegrationTest
  test "should get index" do
    get root_org_root_url
  ...
  test "should handle different request formats" do
    # Test HTML format
    get root_org_root_url, headers: { "Accept" => "text/html" }
  ...
  test "should handle different user agent strings" do
    ...
    user_agents.each do |ua|
      get root_org_root_url, headers: { "User-Agent" => ua }
  ...
  test "should handle requests with admin-specific headers" do
    ...
    get root_org_root_url, headers: admin_headers
  ...
  test "should handle admin dashboard stress scenarios" do
    ...
    stress_params.each do |params|
      get root_org_root_url, params: params
  ...
  test "sets lang attribute on html element" do
    get root_org_root_url(format: :html)
  ...
  #   get root_org_root_url(format: :html), headers: {
  ...
  test "renders expected layout structure" do
    ...
    assert_select "body", count: 1 do
      assert_select "header", count: 1 do
        assert_select "h1", text: "#{ brand_name } (root, org)"
      end
