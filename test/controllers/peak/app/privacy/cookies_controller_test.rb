...
class Peak::App::Privacy::CookiesControllerTest < ActionDispatch::IntegrationTest
  # rubocop:disable Minitest/MultipleAssertions
  test "should get edit" do
    original_forgery_setting = ActionController::Base.allow_forgery_protection
    ActionController::Base.allow_forgery_protection = true

    get edit_peak_app_privacy_cookie_url

    assert_response :success
    assert_select "h1", I18n.t("peak.app.preference.cookie.edit.h1")
    expected_action = peak_app_privacy_cookie_url(ri: "jp", tz: "jst", lx: "ja")
    assert_select "form[action=?]", expected_action do
      ...
      assert_select "label", I18n.t("peak.app.preference.cookie.edit.accept_necessary_cookies")
      assert_select "label", I18n.t("peak.app.preference.cookie.edit.accept_targeting_cookies")
      assert_select "label", I18n.t("peak.app.preference.cookie.edit.accept_functional_cookies")
      assert_select "label", I18n.t("peak.app.preference.cookie.edit.accept_performance_cookies")
      assert_select "input[type='submit']", count: 1
    end
    assert_select "a[href^='#{peak_app_preference_path}']", text: I18n.t("peak.app.preferences.back_to_settings")
  ensure
  ...
  test "submitting the form toggles the checkboxes via persisted preferences" do
    ...
    patch peak_app_privacy_cookie_url,
          params: {
