...
class Peak::App::Preference::LocalesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "edit form preselects timezone matching session value" do
    patch peak_app_preference_locale_url, params: { timezone: "Asia/Tokyo" }
    follow_redirect!
  ...
  test "PATCH with language and timezone updates session and redirects" do
    patch peak_app_preference_locale_url, params: { language: "EN", timezone: "Asia/Tokyo" }

    assert_redirected_to edit_peak_app_preference_locale_url(lx: "en", tz: "asia/tokyo")
  ...
  test "PATCH with language normalizes to uppercase and stores in session" do
    patch peak_app_preference_locale_url, params: { language: "ja" }
  ...
  test "PATCH with unsupported language returns unprocessable entity" do
    patch peak_app_preference_locale_url, params: { language: "invalid" }
  ...
  test "PATCH with invalid timezone returns unprocessable entity" do
    patch peak_app_preference_locale_url, params: { timezone: "Invalid/Timezone" }
  ...
  test "GET edit with lx parameter preselects language without saving to session" do
    get edit_peak_app_preference_locale_url(lx: "en")
  ...
  test "GET edit with tz parameter preselects timezone without saving to session" do
    get edit_peak_app_preference_locale_url(tz: "utc")
  ...
  test "GET edit with multiple URL parameters preselects all options" do
    get edit_peak_app_preference_locale_url(lx: "en", tz: "utc")
  ...
  test "URL parameters take precedence over session values" do
    # Set session values
    patch peak_app_preference_locale_url, params: { language: "JA", timezone: "Asia/Tokyo" }
    follow_redirect!
  ...
  test "URL parameter lx normalizes ja to lowercase for display" do
    get edit_peak_app_preference_locale_url(lx: "ja")
  ...
  test "URL parameter tz normalizes jst to Asia/Tokyo for display" do
    get edit_peak_app_preference_locale_url(tz: "jst")
  ...
  test "multiple preference updates should maintain cookie consistency" do
    ...
    # Second update
    patch peak_app_preference_locale_url, params: { timezone: "Etc/UTC" }
  ...
  test "PATCH with empty params should not update session" do
    ...
    patch peak_app_preference_locale_url, params: {}
    follow_redirect!
