...
class Peak::Com::Preference::RegionsControllerTest < ActionDispatch::IntegrationTest
  setup do
    https!
  end
  # rubocop:disable Minitest/MultipleAssertions
  test "GET edit renders form with region select only" do
    get edit_peak_com_preference_region_url

    assert_response :success
    assert_select "h1", text: I18n.t("peak.com.preferences.regions.title")
  ...
  test "edit form contains region section with proper structure" do
    ...
    assert_select "form[method='post']" do
      ...
      assert_select ".region-section" do
        assert_select "h2", text: I18n.t("peak.com.preferences.regions.region_section")
        assert_select "label[for='region']", text: I18n.t("peak.com.preferences.regions.select_region")
  ...
  test "edit form preselects region matching session value" do
    patch peak_com_preference_region_url, params: { region: "US" }
    follow_redirect!
  ...
  test "PATCH with region updates session and redirects with success notice" do
    patch peak_com_preference_region_url, params: { region: "US", country: "US" }

    assert_redirected_to edit_peak_com_preference_region_url(ri: "us")
  ...
  test "GET edit with ri parameter preselects region without saving to session" do
    get edit_peak_com_preference_region_url(ri: "us")
  ...
  test "URL parameter takes precedence over session value" do
    # Set session value
    patch peak_com_preference_region_url, params: { region: "JP" }
    follow_redirect!
  ...
  test "URL parameter ri normalizes jp to JP for display" do
    get edit_peak_com_preference_region_url(ri: "jp")
  ...
  test "PATCH should persist region preference and redirect with correct parameters" do
    ...
    assert_redirected_to edit_peak_com_preference_region_url(ri: "jp")
  ...
  test "GET edit with ct=dr parameter preselects dark theme" do
    get edit_peak_com_preference_region_url(ct: "dr")
  ...
  test "GET edit with ct=sy parameter preselects system theme" do
    get edit_peak_com_preference_region_url(ct: "sy")

    assert_response :success
  end

  test "GET edit with ct=li parameter preselects light theme" do
    get edit_peak_com_preference_region_url(ct: "li")
  ...
  test "theme parameter should be processed correctly" do
    ...
    get edit_peak_com_preference_region_url(ct: "dark")
    patch peak_com_preference_region_url, params: { region: "JP" }
  ...
  test "light theme parameter should be processed" do
    get edit_peak_com_preference_region_url(ct: "light")
    patch peak_com_preference_region_url, params: { region: "JP" }
  ...
  test "PATCH with empty params should not update session" do
    ...
    patch peak_com_preference_region_url, params: {}
    follow_redirect!
