...
class Peak::Com::Privacy::CookiesControllerTest < ActionDispatch::IntegrationTest
  # rubocop:disable Minitest/MultipleAssertions
  test "should get edit" do
    original_forgery_setting = ActionController::Base.allow_forgery_protection
    ActionController::Base.allow_forgery_protection = true

    get edit_peak_com_privacy_cookie_url

    assert_response :success
    assert_select "h1", I18n.t("peak.com.preference.cookie.edit.h1")
    expected_action = peak_com_privacy_cookie_url(ri: "jp", tz: "jst", lx: "ja")
    assert_select "form[action=?]", expected_action do
      ...
      assert_select "label", I18n.t("peak.com.preference.cookie.edit.accept_necessary_cookies")
      assert_select "label", I18n.t("peak.com.preference.cookie.edit.accept_targeting_cookies")
      assert_select "label", I18n.t("peak.com.preference.cookie.edit.accept_functional_cookies")
