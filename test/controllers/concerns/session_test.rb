...
class SessionConcernTest < ActionDispatch::IntegrationTest
  ...
  test "allows flash for explicitly allowed transitions" do
    allowed_transitions = [
      ["sign.app.localhost", "core.app.localhost"],
      ["sign.com.localhost", "core.com.localhost"],
      ["sign.org.localhost", "core.org.localhost"],
      ["sign.app.localhost", "apex.app.localhost"],
      ["sign.com.localhost", "apex.com.localhost"],
      ["sign.org.localhost", "apex.org.localhost"],
    ]
