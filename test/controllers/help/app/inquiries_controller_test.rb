...
class Help::App::InquiriesControllerTest < ActionDispatch::IntegrationTest
  ...
  #   assert_select "h1", I18n.t("controller.docs.app.contacts.new.page_title")
  ...
  #                   I18n.t("controller.docs.app.contacts.new.confirm_policy")
  ...
  # #   assert_select "h1", I18n.t("controller.docs.app.contacts.new.page_title")
  # #   assert_select "p", "Find me in app/views/sign/app/contacts/new.html.erb"
  # #   assert_select "form[action=?][method=?]", root_app_contact_email_path, "post" do
