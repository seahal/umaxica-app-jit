...
class Auth::Org::Setting::PasskeysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should get index" do
    get auth_org_setting_passkeys_url, headers: @headers
  ...
  test "should get new" do
    get new_auth_org_setting_passkey_url, headers: @headers
  ...
  test "redirects unauthenticated staff to login" do
    get auth_org_setting_passkeys_url, headers: @host_headers

    assert_response :redirect
    assert_match new_auth_org_authentication_path, response.headers["Location"]
  end
