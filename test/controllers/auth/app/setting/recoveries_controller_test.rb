    ...
    module Setting
      class RecoveriesControllerTest < ActionDispatch::IntegrationTest
        ...
        test "should get index" do
          get auth_app_setting_recoveries_url, headers: @headers

          assert_response :success
        end

        test "should get new" do
          get new_auth_app_setting_recovery_url, headers: @headers
        ...
        test "should create recovery code" do
          ...
          assert_difference("UserRecoveryCode.count") do
            post auth_app_setting_recoveries_url, params: {
              user_recovery_code: { confirm_create_recovery_code: "1" }
            }, headers: @headers
          end

          assert_redirected_to auth_app_setting_recovery_url(UserRecoveryCode.last, regional_defaults)
        end
        ...
        test "should show recovery code" do
          ...
          get auth_app_setting_recovery_url(recovery_code), headers: @headers
        ...
        test "should destroy recovery code" do
          ...
          assert_difference("UserRecoveryCode.count", -1) do
            delete auth_app_setting_recovery_url(recovery_code), headers: @headers
          end

          assert_redirected_to auth_app_setting_recoveries_url(regional_defaults)
        end
