...
class Docs::Org::Web::V0::ThemeControllerTest < ActionDispatch::IntegrationTest
  ...
  test "GET show without access jwt returns default theme sy" do
    ...
    get docs_org_web_v0_theme_path, as: :json
  ...
  test "PATCH update sets theme cookie and returns updated theme" do
    ...
    with_preference_jwt_keys(host: @host) do
      patch docs_org_web_v0_theme_path, params: { theme: "dark" }, as: :json
    end
