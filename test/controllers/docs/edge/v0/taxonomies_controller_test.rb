    ...
    module V0
      class TaxonomiesControllerTest < ActionDispatch::IntegrationTest
        ...
        TAXONOMY_SPECS = [
          {
            name: "docs com tags",
            url_helper: :docs_com_edge_v0_tags_url,
          ...
          },
          {
            ...
            url_helper: :docs_com_edge_v0_categories_url,
          ...
          {
            name: "docs app tags",
            url_helper: :docs_app_edge_v0_tags_url,
          ...
          },
          {
            ...
            url_helper: :docs_app_edge_v0_categories_url,
          ...
          {
            name: "docs org tags",
            url_helper: :docs_org_edge_v0_tags_url,
          ...
          },
          {
            ...
            url_helper: :docs_org_edge_v0_categories_url,
