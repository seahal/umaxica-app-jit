    ...
    module V1
      class PostsControllerTest < ActionDispatch::IntegrationTest
        ...
        test "should show document by permalink" do
          get docs_com_v1_post_url(id: @document.permalink)
        ...
        test "should show 404 for non-existent permalink" do
          get docs_com_v1_post_url(id: "nonexistent_permalink_xyz")
        ...
        test "should handle redirect response mode" do
          ...
          get docs_com_v1_post_url(id: redirect_doc.permalink)
        ...
        test "should handle text response mode" do
          ...
          get docs_com_v1_post_url(id: text_doc.permalink)
          assert_response :success
        ...
        test "should not show expired documents" do
          ...
          get docs_com_v1_post_url(id: expired_doc.permalink)
          assert_response :not_found
        end
        ...
        test "should not show unpublished documents" do
          ...
          get docs_com_v1_post_url(id: future_doc.permalink)
          assert_response :not_found
        end
        ...
        test "should show all documents list" do
          get docs_com_v1_posts_url
          assert_response :success
        end

        test "should search documents by query" do
          get docs_com_v1_posts_url(q: "test")
          assert_response :success
        end
        ...
        test "should handle empty search results" do
          get docs_com_v1_posts_url(q: "nonexistent_query_xyz")
          assert_response :success
