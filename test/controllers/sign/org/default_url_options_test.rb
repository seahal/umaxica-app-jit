  ...
  module Org
    class DefaultUrlOptionsTest < ActionDispatch::IntegrationTest
      ...
      test "default_url_options updates after preference change" do
        ...
        assert_redirected_to edit_sign_org_preference_region_url(lx: "en", ri: "us", tz: "etc/utc")
      ...
      test "default_url_options handles partial cookie data" do
        ...
        assert_redirected_to edit_sign_org_preference_region_url(lx: "en", ri: "jp", tz: "jst")
      end
      # rubocop:enable Minitest/MultipleAssertions
    end
  end
