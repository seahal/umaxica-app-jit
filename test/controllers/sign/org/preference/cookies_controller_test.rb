...
class Sign::Org::Preference::CookiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should get edit" do
    ...
    assert_select "h1", I18n.t("sign.org.preference.cookie.edit.h1")
    expected_action = sign_org_preference_cookie_url(ri: "jp", tz: "jst", lx: "ja")
    assert_select "form[action=?]", expected_action do
      ...
      assert_select "label", I18n.t("sign.org.preference.cookie.edit.accept_necessary_cookies")
      assert_select "label", I18n.t("sign.org.preference.cookie.edit.accept_targeting_cookies")
      assert_select "label", I18n.t("sign.org.preference.cookie.edit.accept_functional_cookies")
