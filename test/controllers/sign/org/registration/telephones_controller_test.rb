...
class Sign::Org::Registration::TelephonesControllerTest < ActionDispatch::IntegrationTest
  ...
  #   get new_sign_org_registration_telephone_url, headers: { "Host" => ENV["SIGN_STAFF_URL"] }
  ...
  #   end
  #   assert_select "a[href=?]", new_sign_org_registration_path
  #   assert_select "a[href=?]", new_sign_org_authentication_telephone_path
  # end
end
