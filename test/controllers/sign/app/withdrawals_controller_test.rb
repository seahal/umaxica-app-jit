...
class Sign::App::WithdrawalsControllerTest < ActionDispatch::IntegrationTest
  ...
  #   expected_label = I18n.t("sign.app.withdrawal.new.recovery_code_label")
  ...
  test "edit withdrawal page renders confirm_create_recovery_code checkbox" do
    ...
    expected_label = I18n.t("sign.app.withdrawal.edit.recovery_code_label")
  ...
  test "create accepts confirm_create_recovery_code parameter" do
    ...
    post sign_app_withdrawal_url, params: { confirm_create_recovery_code: "1" },
  ...
  test "update accepts confirm_create_recovery_code parameter" do
    ...
    patch sign_app_withdrawal_url, params: { confirm_create_recovery_code: "1" },
                                   headers: request_headers.merge("X-TEST-CURRENT-USER" => @user.id)
  ...
  test "should destroy user account" do
    ...
    assert_match %r{\A#{Regexp.escape(sign_app_root_url)}}, @response.location
    assert_equal I18n.t("sign.app.withdrawal.destroy.success"), flash[:notice]
  end
  ...
  test "should handle failure during destroy" do
    ...
    assert_response :redirect
    assert_match %r{\A#{Regexp.escape(sign_app_root_url)}}, @response.location
    assert_equal I18n.t("sign.app.withdrawal.destroy.failed"), flash[:alert]
  end
  ...
  test "should handle update failure" do
    ...
    assert_response :redirect
    assert_match %r{\A#{Regexp.escape(sign_app_root_url)}}, @response.location
    assert_equal I18n.t("sign.app.withdrawal.update.failed"), flash[:alert]
  end
end
