      ...
      module V1
        class HealthsControllerTest < ActionDispatch::IntegrationTest
          ...
          test "returns success for default format" do
            get sign_app_edge_v1_health_url(ri: "jp")
          ...
          test "returns success for explicit html format" do
            get sign_app_edge_v1_health_url(format: :html, ri: "jp")
          ...
          test "returns OK status payload for json format" do
            get sign_app_edge_v1_health_url(format: :json, ri: "jp")
          ...
          test "raises error for unsupported yaml format" do
            get sign_app_edge_v1_health_url(format: :yaml, ri: "jp")
          ...
          test "json response conforms to OpenAPI schema" do
            get sign_app_edge_v1_health_url(ri: "jp"), headers: { "Accept" => "application/json" }
