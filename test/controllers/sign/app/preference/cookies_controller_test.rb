...
class Sign::App::Preference::CookiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should get edit" do
    ...
    assert_select "h1", I18n.t("sign.app.preference.cookie.edit.h1")
    assert_select "div#hello-world-component", count: 1
    expected_action = sign_app_preference_cookie_url(ri: "jp", tz: "jst", lx: "ja")
    assert_select "form[action=?]", expected_action do
      ...
      assert_select "label", I18n.t("sign.app.preference.cookie.edit.accept_necessary_cookies")
      assert_select "label", I18n.t("sign.app.preference.cookie.edit.accept_targeting_cookies")
      assert_select "label", I18n.t("sign.app.preference.cookie.edit.accept_functional_cookies")
      assert_select "label", I18n.t("sign.app.preference.cookie.edit.accept_performance_cookies")
  ...
  test "submitting the form toggles the checkboxes via persisted preferences" do
    ...
    patch sign_app_preference_cookie_url,
          params: {
