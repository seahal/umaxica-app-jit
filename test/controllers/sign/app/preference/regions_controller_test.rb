...
class Sign::App::Preference::RegionsControllerTest < ActionDispatch::IntegrationTest
  # rubocop:disable Minitest/MultipleAssertions
  test "GET edit renders form with region language and timezone selects" do
    get edit_sign_app_preference_region_url

    assert_response :success
    assert_select "h1", text: I18n.t("sign.app.preferences.regions.title")
  ...
  test "edit form contains region language and timezone sections with proper structure" do
    ...
    assert_select "main.container.mx-auto.mt-28.px-5.block" do
      expected_action = sign_app_preference_region_url(ri: "jp", tz: "jst", lx: "ja")
      assert_select "form[action=?][method='post']", expected_action do
        ...
        assert_select ".region-section" do
          assert_select "h2", text: I18n.t("sign.app.preferences.regions.region_section")
          assert_select "label[for='region']", text: I18n.t("sign.app.preferences.regions.select_region")
          assert_select "select#region option[value='US']"
          assert_select "select#region option[value='JP']"
        end

        assert_select ".language-section" do
          assert_select "h2", text: I18n.t("sign.app.preferences.regions.language_section")
          assert_select ".language-selection label[for='language']", text: I18n.t("sign.app.preferences.regions.select_language")
        ...
        assert_select ".timezone-section" do
          assert_select "h2", text: I18n.t("sign.app.preferences.regions.timezone_section")
          assert_select ".timezone-selection label[for='timezone']", text: I18n.t("sign.app.preferences.regions.select_timezone")
  ...
  test "edit form preselects options matching session values" do
    patch sign_app_preference_region_url, params: { region: "US", language: "EN", timezone: "Asia/Tokyo" }
    follow_redirect!
  ...
  test "PATCH with multiple params updates session and redirects with success notice" do
    patch sign_app_preference_region_url, params: { region: "US", country: "US", language: "EN", timezone: "Asia/Tokyo" }

    assert_redirected_to edit_sign_app_preference_region_url(lx: "en", ri: "us", tz: "asia/tokyo")
  ...
  test "PATCH with language normalizes to uppercase and stores in session" do
    patch sign_app_preference_region_url, params: { language: "ja" }
  ...
  test "PATCH with unsupported language returns unprocessable entity" do
    patch sign_app_preference_region_url, params: { language: "invalid" }

    assert_response :unprocessable_content
  end

  test "PATCH with timezone stores timezone identifier in session" do
    patch sign_app_preference_region_url, params: { timezone: "Asia/Tokyo" }
  ...
  test "PATCH with invalid timezone returns unprocessable entity" do
    patch sign_app_preference_region_url, params: { timezone: "Invalid/Timezone" }
  ...
  test "GET edit with lx parameter preselects language without saving to session" do
    get edit_sign_app_preference_region_url(lx: "en")
  ...
  test "GET edit with ri parameter preselects region without saving to session" do
    get edit_sign_app_preference_region_url(ri: "us")
  ...
  test "GET edit with tz parameter preselects timezone without saving to session" do
    get edit_sign_app_preference_region_url(tz: "utc")
  ...
  test "GET edit with multiple URL parameters preselects all options" do
    get edit_sign_app_preference_region_url(lx: "en", ri: "us", tz: "utc")
  ...
  test "URL parameter lx normalizes ja to JA for display" do
    get edit_sign_app_preference_region_url(lx: "ja")
  ...
  test "URL parameter tz normalizes jst to Asia/Tokyo for display" do
    get edit_sign_app_preference_region_url(tz: "jst")
  ...
  test "URL parameter tz normalizes kst to Asia/Seoul for display" do
    get edit_sign_app_preference_region_url(tz: "kst")
  ...
  test "preferences should persist across multiple updates" do
    patch sign_app_preference_region_url, params: { timezone: "Etc/UTC" }
  ...
  test "GET edit with ct=dr parameter preselects dark theme" do
    get edit_sign_app_preference_region_url(ct: "dr")
  ...
  test "GET edit with ct=sy parameter preselects system theme" do
    get edit_sign_app_preference_region_url(ct: "sy")

    assert_response :success
  end

  test "GET edit with ct=li parameter preselects light theme" do
    get edit_sign_app_preference_region_url(ct: "li")
  ...
  test "theme parameter should be processed correctly" do
    ...
    get edit_sign_app_preference_region_url(ct: "dark")
    patch sign_app_preference_region_url, params: { region: "JP" }
  ...
  test "light theme parameter should be processed" do
    get edit_sign_app_preference_region_url(ct: "light")
    patch sign_app_preference_region_url, params: { region: "JP" }
  ...
  test "PATCH with empty params should not update session" do
    ...
    patch sign_app_preference_region_url, params: {}
    follow_redirect!
