...
class Sign::App::ConfigurationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should get show when logged in" do
    ...
    assert_select "a[href^=?]", sign_app_configuration_security_path(ri: "jp")
    assert_select "a[href^=?]", sign_app_configuration_withdrawal_path(ri: "jp")
    assert_select "a[href*=?]", edit_sign_app_out_path(ri: "jp"), text: I18n.t("sign.app.layout.nav.logout")
  end
