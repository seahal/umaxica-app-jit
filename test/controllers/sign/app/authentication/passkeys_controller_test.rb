...
module Sign::App::Authentication
  class PasskeysControllerTest < ActionDispatch::IntegrationTest
    test "should get new" do
      get new_sign_app_authentication_passkey_url
    ...
    test "should get edit" do
      get edit_sign_app_authentication_passkey_url

      assert_response :success
    end

    test "should return ok on create when not logged in" do
      post sign_app_authentication_passkey_url

      assert_response :ok
    end

    test "should return ok on update when not logged in" do
      patch sign_app_authentication_passkey_url
