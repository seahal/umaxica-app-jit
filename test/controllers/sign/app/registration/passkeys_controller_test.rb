...
module Sign::App::Registration
  class PasskeysControllerTest < ActionDispatch::IntegrationTest
    setup do
      ...
      Sign::App::Registration::PasskeysController.send(:define_method, :cloudflare_turnstile_validation) do
        { "success" => true }
      end
    ...
    test "should get new" do
      get new_sign_app_registration_passkey_url
    ...
    test "should create telephone and redirect to edit" do
      assert_difference("UserIdentityTelephone.count") do
        post sign_app_registration_passkeys_url, params: {
      ...
      assert_redirected_to edit_sign_app_registration_passkey_url(telephone, regional_defaults)
    ...
    test "should update telephone with valid otp" do
      ...
      # 3. Submit OTP
      patch sign_app_registration_passkey_url(telephone), params: {
