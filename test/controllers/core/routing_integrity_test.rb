...
class CoreRoutingIntegrityTest < ActionDispatch::IntegrationTest
  test "core app root route exists" do
    assert_generates "/", { controller: "core/app/roots", action: "index" }
  end

  test "core app health route exists" do
    assert_generates "/health", { controller: "core/app/healths", action: "show" }
  end

  test "core app sitemap route exists" do
    assert_generates "/sitemap.xml", { controller: "core/app/sitemaps", action: "show" }
  end

  test "core com root route exists" do
    assert_generates "/", { controller: "core/com/roots", action: "index" }
  end

  test "core org root route exists" do
    assert_generates "/", { controller: "core/org/roots", action: "index" }
  end
  ...
  test "edge v0 routes are properly namespaced" do
    assert_generates "/edge/v0/health", { controller: "core/app/edge/v0/healths", action: "show" }
    assert_generates "/edge/v0/sitemap", { controller: "core/app/edge/v0/sitemaps", action: "show" }
  end

  test "web v0 routes are properly namespaced" do
    assert_generates "/web/v0/cookie", { controller: "core/app/web/v0/cookies", action: "show" }
    assert_generates "/web/v0/theme", { controller: "core/app/web/v0/themes", action: "show" }
  end
end
