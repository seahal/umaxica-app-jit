...
class Core::App::Configuration::RootsControllerTest < ActionDispatch::IntegrationTest
  fixtures :users, :user_statuses

  setup do
    host! ENV.fetch("SIGN_APP_URL", ENV.fetch("CORE_SERVICE_URL", "www.app.localhost"))
    @user = users(:one)
  end
