...
<<<<<<<< HEAD:test/controllers/core/org/web/v0/cookie_controller_test.rb
class Core::Org::Web::V0::CookieControllerTest < ActionDispatch::IntegrationTest
========
class Core::Org::Web::V0::CookiesControllerTest < ActionDispatch::IntegrationTest
>>>>>>>> 98bd02f0f ([CheckPoint] renamimg from main to core.):test/controllers/core/org/web/v0/cookies_controller_test.rb
  ...
  test "GET show without access jwt returns consented false" do
    ...
    get core_org_web_v0_cookie_path, as: :json
  ...
  test "PATCH update with consented true updates preference cookie and issues access token" do
    ...
    with_preference_jwt_keys(host: @host) do
      patch core_org_web_v0_cookie_path, params: { consented: true }, as: :json
    end
