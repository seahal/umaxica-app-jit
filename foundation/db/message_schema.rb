...
ActiveRecord::Schema[8.2].define(version: 2026_03_09_000001) do
  ...
  create_table "member_messages", force: :cascade do |t|
    ...
    t.timestamptz "updated_at", null: false
    t.bigint "user_message_id"
    t.index ["public_id"], name: "index_member_messages_on_public_id", unique: true
    t.index ["user_message_id"], name: "index_member_messages_on_user_message_id"
  end

  create_table "operator_messages", force: :cascade do |t|
    t.timestamptz "created_at", null: false
    t.string "public_id", default: "", null: false
    t.bigint "staff_message_id"
    t.timestamptz "updated_at", null: false
    t.index ["public_id"], name: "index_operator_messages_on_public_id", unique: true
    t.index ["staff_message_id"], name: "index_operator_messages_on_staff_message_id"
  end
