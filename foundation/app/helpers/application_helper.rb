...
module ApplicationHelper
  ...
  def edge_host
    surface = request.respond_to?(:host) ? Surface.current(request) : Surface::DEFAULT
    env_key = EDGE_HOST_ENV_KEYS.fetch(surface, EDGE_HOST_ENV_KEYS.fetch(Surface::DEFAULT))

    HostNormalization.normalize(ENV[env_key])
  end
