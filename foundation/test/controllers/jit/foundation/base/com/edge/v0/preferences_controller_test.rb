          ...
          module V0
            class PreferenceControllerTest < ActionDispatch::IntegrationTest
              ...
              test "should get show with existing preference" do
                ...
                get foundation.base_com_edge_v0_preference_url
              ...
              test "should recreate missing reference defaults before creating a new preference" do
                ComPreference.find_each(&:destroy!)
                ComPreferenceBindingMethod.delete_all
                ...
                assert_response :success
                assert_equal [0, 1, 2], ComPreferenceBindingMethod.order(:id).pluck(:id)
                assert_equal [0, 1, 2, 3, 4], ComPreferenceDbscStatus.order(:id).pluck(:id)
                assert_equal ComPreferenceBindingMethod::LEGACY, ComPreference.order(:created_at).last.binding_method_id
                assert_equal ComPreferenceDbscStatus::NOTHING, ComPreference.order(:created_at).last.dbsc_status_id
              end
