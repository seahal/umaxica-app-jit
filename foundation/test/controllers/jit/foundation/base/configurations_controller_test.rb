...
# frozen_string_literal: true
    ...
    class Base::App::ConfigurationsControllerTest < ActionDispatch::IntegrationTest
    ...
    class Base::Com::ConfigurationsControllerTest < ActionDispatch::IntegrationTest
      fixtures :users, :user_statuses
    ...
    class Base::Org::ConfigurationsControllerTest < ActionDispatch::IntegrationTest
