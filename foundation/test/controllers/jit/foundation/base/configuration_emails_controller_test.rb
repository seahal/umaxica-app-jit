...
# frozen_string_literal: true
    ...
    class Base::App::Configuration::EmailsControllerTest < ActionDispatch::IntegrationTest
    ...
    class Base::Org::Configuration::EmailsControllerTest < ActionDispatch::IntegrationTest
