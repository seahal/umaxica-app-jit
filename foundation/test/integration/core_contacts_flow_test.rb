...
class CoreContactsFlowTest < ActionDispatch::IntegrationTest
  ...
  test "app contacts new redirects when not logged in" do
    host! @app_host
    get foundation.new_base_app_contact_url
  ...
  test "app contacts requires registered email and telephone in new/create" do
    ...
    get foundation.new_base_app_contact_url, headers: app_auth_headers(@user)
    ...
    post foundation.base_app_contacts_url, headers: app_auth_headers(@user), params: {
  ...
  test "app contacts rejects staff auth headers" do
    ...
    get foundation.new_base_app_contact_url, headers: org_auth_headers(@staff)
  ...
  test "org contacts new redirects when not logged in" do
    host! @org_host
    get foundation.new_base_org_contact_url
  ...
  test "org contacts requires registered email and telephone" do
    ...
    get foundation.new_base_org_contact_url, headers: org_auth_headers(@staff)
  ...
  test "org contacts rejects user auth headers" do
    ...
    get foundation.new_base_org_contact_url, headers: app_auth_headers(@user)
  ...
  test "org contacts creates inquiry directly" do
    ...
    Jit::Security::TurnstileConfig.stub(:stealth_secret_key, nil) do
      assert_difference(
        ...
        post foundation.base_org_contacts_url, headers: org_auth_headers(@staff), params: {
  ...
  test "org contacts new with invalid category renders form with nil category" do
    ...
    get foundation.new_base_org_contact_url(category: "invalid"), headers: org_auth_headers(@staff)
  ...
  test "org contacts new with valid category passes category to form" do
    ...
    get foundation.new_base_org_contact_url(category: category.id), headers: org_auth_headers(@staff)
  ...
  test "com contacts completes contact on submit without verification" do
    ...
    assert_difference(["ComContact.count", "ComContactTopic.count"], 1) do
      post foundation.base_com_contacts_url, params: {
        com_contact: {
  ...
  test "com contacts stays public when customer auth headers are present" do
    ...
    get foundation.new_base_com_contact_url, headers: as_customer_headers(customer, host: @com_host)

    assert_response :success

    assert_difference(["ComContact.count", "ComContactTopic.count"], 1) do
      post foundation.base_com_contacts_url,
