...
- **Exit**:
  ...
  - Release checklist (`docs/tasks/checklist.md`) signed off by Product + Engineering.
...
- Document manual steps for smoke/perf tests in `docs/tasks/checklist.md` or runbooks.
