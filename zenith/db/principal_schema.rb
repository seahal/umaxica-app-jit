...
ActiveRecord::Schema[8.2].define(version: 2026_04_15_000004) do
  ...
  create_table "user_emails", force: :cascade do |t|
    ...
    t.timestamptz "otp_last_sent_at", default: -::Float::INFINITY, null: false
  ...
  create_table "user_memberships", force: :cascade do |t|
    t.timestamptz "created_at", null: false
    t.timestamptz "joined_at", default: -> { "CURRENT_TIMESTAMP" }, null: false
    t.timestamptz "left_at", default: -::Float::INFINITY, null: false
    t.timestamptz "updated_at", null: false
    t.bigint "user_id", null: false
  ...
  create_table "user_one_time_passwords", force: :cascade do |t|
    t.timestamptz "created_at", null: false
    t.timestamptz "last_otp_at", default: -::Float::INFINITY, null: false
  ...
  create_table "user_secrets", force: :cascade do |t|
    t.timestamptz "created_at", null: false
    t.timestamptz "expires_at", default: ::Float::INFINITY, null: false
    t.timestamptz "last_used_at"
    t.string "name", default: "", null: false
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.timestamptz "scheduled_purge_at"
    t.timestamptz "shreddable_at", default: ::Float::INFINITY, null: false
    t.bigint "status_id", default: 0, null: false
    t.timestamptz "updated_at", null: false
    t.bigint "visibility_id", default: 2, null: false
    t.timestamptz "withdrawal_started_at"
    t.timestamptz "withdrawn_at", default: ::Float::INFINITY
  ...
  add_foreign_key "user_authorization_codes", "users"
