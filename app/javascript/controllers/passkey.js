import { csrfToken, toB64url, fromB64url, decodeCreationOptions } from "./passkey_helpers.js";

const btn = typeof document !== "undefined" ? document.getElementById("add-passkey") : null;
