...
#  index_member_avatar_deletions_on_member_id                (member_id)
...
class MemberAvatarDeletion < AvatarRecord
  belongs_to :member, inverse_of: :member_avatar_deletions
  belongs_to :avatar, inverse_of: :member_avatar_deletions
