...
class UserClientImpersonation < PrincipalRecord
  belongs_to :user, inverse_of: :user_client_impersonations
  belongs_to :client, inverse_of: :user_client_impersonations
