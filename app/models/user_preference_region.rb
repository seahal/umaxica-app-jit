...
#
class UserPreferenceRegion < PrincipalRecord
  belongs_to :preference, class_name: "UserPreference", inverse_of: :user_preference_region
  belongs_to :option,
             class_name: "UserPreferenceRegionOption",
             inverse_of: :user_preference_regions,
             optional: true
  ...
  def set_option_id
    self.option_id ||= UserPreferenceRegionOption::JP
  end
end
