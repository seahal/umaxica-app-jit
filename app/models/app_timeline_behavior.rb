...
# Indexes
#
#  idx_on_subject_type_subject_id_occurred_at_72b011a3db     (subject_type,subject_id,occurred_at)
#  index_app_timeline_behaviors_on_actor_id_and_occurred_at  (actor_id,occurred_at)
#  index_app_timeline_behaviors_on_event_id                  (event_id)
#  index_app_timeline_behaviors_on_expires_at                (expires_at)
#  index_app_timeline_behaviors_on_level_id                  (level_id)
#  index_app_timeline_behaviors_on_occurred_at               (occurred_at)
...
class AppTimelineBehavior < ActivityRecord
