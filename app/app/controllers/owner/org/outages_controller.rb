...
class Owner::Org::OutagesController < Owner::BaseController
  # GET /owner/org/outage
  def show
    ...
    # - DB: read the single outage_states row where surface=org
    # - Redis/FeatureFlag: read "outage:org" (audit log stored elsewhere)
    render json: { surface: "org", status: "running" }
  end

  # PATCH /owner/org/outage
  def update
    ...
    #
    # Example: OutageService.update!(surface: :org, attrs: outage_params, actor: current_owner)
    head :no_content
  end
