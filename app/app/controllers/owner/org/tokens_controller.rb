...
class Owner::Org::TokensController < Owner::BaseController
  # GET /owner/org/token
  def show
    ...
    render json: { surface: "org", token_version: 1 }
  end

  # PATCH /owner/org/token
  def update
    ...
    # - TokenEmergencyService.call!(surface: :org, action:, reason:, actor:)
