...
class Owner::App::TokensController < Owner::BaseController
  # GET /owner/app/token
  def show
    ...
    render json: { surface: "app", token_version: 1 }
  end

  # PATCH /owner/app/token
  def update
    ...
    # - TokenEmergencyService.call!(surface: :app, action:, reason:, actor:)
