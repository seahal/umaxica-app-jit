      ...
      class RegionsController < ApplicationController
        ...
        def update
          ...
          if result.error?
            ...
            redirect_to edit_root_org_preference_region_url
          end
        end
        ...
        def update_language(language)
          ...
          unless SELECTABLE_LANGUAGES.include?(normalized)
            return Result.new(false, "root.org.preferences.languages.unsupported")
          end
        ...
        def update_timezone(timezone)
          ...
          return Result.new(false, "root.org.preferences.timezones.invalid") unless zone
