      ...
      class RegionsController < ApplicationController
        ...
        def update
          ...
          if result.error?
            ...
            redirect_to edit_root_com_preference_region_url
          end
        end
        ...
        def update_language(language)
          ...
          unless SELECTABLE_LANGUAGES.include?(normalized)
            return Result.new(false, "root.com.preferences.languages.unsupported")
          end
        ...
        def update_timezone(timezone)
          ...
          return Result.new(false, "root.com.preferences.timezones.invalid") unless SELECTABLE_TIMEZONES.any? { |identifier| identifier.casecmp?(candidate) }

          zone = resolve_timezone(candidate)
          return Result.new(false, "root.com.preferences.timezones.invalid") unless zone
