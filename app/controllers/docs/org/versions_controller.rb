  ...
  module Org
    class VersionsController < ApplicationController
      ...
      def create
        ...
        redirect_to docs_org_post_versions_path(safe_post_id), allow_other_host: false
      end
      ...
      def update
        ...
        redirect_to docs_org_post_version_path(safe_post_id, safe_version_id), allow_other_host: false
      end
