...
class Sign::App::Edge::V0::Token::DbscRegistrationsController < Sign::App::Edge::V0::BaseController
  ...
  def handle_registration
    result = Dbsc::RegistrationService.call(
      ...
      expected_audience: sign_app_edge_v0_token_dbsc_registration_url,
    )
    ...
    if result[:ok]
      ...
      render json: {
        ...
        refresh_url: sign_app_edge_v0_token_dbsc_registration_url,
        scope: {
