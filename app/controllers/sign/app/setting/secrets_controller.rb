      ...
      class SecretsController < ApplicationController
        ...
        def create
          ...
          respond_to do |format|
            if @secret.save
              format.html { redirect_to sign_app_setting_secret_path(@secret), notice: t("messages.secret_successfully_created") }
        ...
        def update
          respond_to do |format|
            if @secret.update(secret_params)
              format.html { redirect_to sign_app_setting_secret_path(@secret), notice: t("messages.secret_successfully_updated") }
            else
        ...
        def destroy
          ...
          respond_to do |format|
            format.html { redirect_to sign_app_setting_secrets_path, status: :see_other, notice: t("messages.secret_successfully_destroyed") }
          end
        end
