      ...
      class TelephonesController < ApplicationController
        ...
        def edit
          ...
          if [ session[:user_telephone_registration]["id"] == params["id"],
            ...
            redirect_to new_root_app_registration_telephone_path,
        ...
        def create
          ...
          if res["success"] && @user_telephone.valid?
            ...
            redirect_to edit_root_app_registration_telephone_path(id), notice: t("messages.telephone_successfully_created")
          else
