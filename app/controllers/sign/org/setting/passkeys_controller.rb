      ...
      class PasskeysController < ApplicationController
        ...
        def update
          if @passkey.update(passkey_params)
            redirect_to sign_org_setting_passkey_path(@passkey), notice: t("messages.passkey_updated_successfully")
          else
            render :edit
          end
        end
        ...
        def destroy
          @passkey.deactivate!
          redirect_to sign_org_setting_passkeys_path, notice: t("messages.passkey_removed_successfully")
        end
