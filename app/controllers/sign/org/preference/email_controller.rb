  ...
  module Org
    module Preference
      class EmailController < ApplicationController
        ...
        before_action :authenticate_staff!, only: %i(show update)
        ...
        def create
          ...
          store_email(email)
          redirect_to(sign_org_preference_email_path(id: "primary"))
        end
        ...
        def update
          ...
          store_email(email)
          redirect_to(sign_org_preference_email_path(id: params[:id]))
        end
