    ...
    class ReauthController < ApplicationController
      ...
      def create
        ...
        if @reauth_session.save
          ...
          redirect_to edit_sign_org_reauth_path(@reauth_session, ri: params[:ri])
        else
      ...
      def destroy
        ...
        redirect_to new_sign_org_reauth_path(
      ...
      def send_email_otp!(reauth_session)
        staff_email =
          current_staff.staff_emails.where(
            staff_identity_email_status_id: %w(VERIFIED
        ...
        Email::App::RegistrationMailer.with(
          ...
          public_id: current_staff.public_id,
      ...
      def verify_success!
        ...
        flash[:notice] = I18n.t("sign.org.reauth.success.complete")
