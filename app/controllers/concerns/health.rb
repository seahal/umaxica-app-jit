...
module Health
  ...
  def show
    ...
    # @status, @body = if !! [IdentifiersRecord, AccountsRecord, NotificationsRecord, CoresRecord, SessionsRecord, StoragesRecord, MessagesRecord].all?{ it.connection.execute("SELECT 1;") }
