  ...
  module App
    class VersionsController < ApplicationController
      ...
      def index
        ...
        Rails.event.notify("news.versions.listed",
                           post_id: @post_id,
      ...
      def show
        ...
        Rails.event.notify("news.version.viewed",
                           post_id: @post_id,
      ...
      def create
        @post_id = params[:post_id]
        Rails.event.notify("news.version.created",
                           post_id: @post_id,)

        redirect_to news_app_post_versions_path(@post_id)
      end
      ...
      def update
        @post_id = params[:post_id]
        @version_id = params[:id]
        Rails.event.notify("news.version.updated",
                           post_id: @post_id,
                           version_id: @version_id,)

        redirect_to news_app_post_version_path(@post_id, @version_id)
      end
      ...
      def destroy
        @post_id = params[:post_id]
        @version_id = params[:id]
        Rails.event.notify("news.version.deleted",
                           post_id: @post_id,
                           version_id: @version_id,)
