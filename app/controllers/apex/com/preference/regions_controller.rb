  ...
  module Com
    module Preference
      class RegionsController < ApplicationController
        SELECTABLE_LANGUAGES = %w[EN JA ES FR DE ZH].freeze
        DEFAULT_LANGUAGE = "EN"
        ...
        def update
          ...
          if result.error?
            ...
            redirect_to edit_apex_com_preference_region_url
          end
        end
        ...
        def update_language(language)
          ...
          unless SELECTABLE_LANGUAGES.include?(normalized)
            return Result.new(false, "apex.com.preferences.languages.unsupported")
          end
        ...
        def update_timezone(timezone)
          ...
          return Result.new(false, "apex.com.preferences.timezones.invalid") unless SELECTABLE_TIMEZONES.any? { |identifier| identifier.casecmp?(candidate) }

          zone = resolve_timezone(candidate)
          return Result.new(false, "apex.com.preferences.timezones.invalid") unless zone
