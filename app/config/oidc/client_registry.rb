    ...
    def build_clients
      {
        ...
        # Core
        "core_app" => {
          redirect_uris: build_redirect_uris("MAIN_SERVICE_URL", "wwww.app.localhost"),
          aud: "umaxica-core-app",
          resource_type: "user",
        },
        "core_org" => {
          redirect_uris: build_redirect_uris("MAIN_STAFF_URL", "wwww.org.localhost"),
          aud: "umaxica-core-org",
          resource_type: "staff",
        },
        "core_com" => {
          redirect_uris: build_redirect_uris("MAIN_CORPORATE_URL", "wwww.com.localhost"),
